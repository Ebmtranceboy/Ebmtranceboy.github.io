...
(function($PS) {
  ...
  var renderPoint = new Render(function (v) {
      return function (v1) {
          return [ svgline(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v1) - 5.0)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v1) - 5.0)(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v1) + 5.0)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v1) + 5.0)(v.stroke)(v.strokeWidth), svgline(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v1) - 5.0)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v1) + 5.0)(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v1) + 5.0)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v1) - 5.0)(v.stroke)(v.strokeWidth), svgtext(SVGpork_Geometry.abs(SVGpork_Geometry.basedPoint)(v1) + 10.0)(SVGpork_Geometry.ord(SVGpork_Geometry.basedPoint)(v1) - 10.0)(v.textFill)(v.fontStyle)(v1.name) ];
      };
  });
  var defaultContext = {
      stroke: "#000",
...
(function($PS) {
  ...
  var update = function (model) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 52, column 16 - line 76, column 24): " + [ v.constructor.name ]);
      };
  };
  var initialModel = {
      circles: [  ],
  ...
  var main = function __do() {
      var inst = Spork_App.makeWithSelector(Spork_Interpreter.merge(Effect.applicativeEffect)(Spork_Interpreter.liftNat(Effect.monadEffect)(runProbe))(Spork_Interpreter.never(Effect.monadEffect)))(app)("#app")();
      return inst.run();
  };
  exports["Probe"] = Probe;
