...
(function($PS) {
  ...
  var unfold = function (n) {
      return function (f) {
          return function (x) {
              var go = function (v) {
                  if (v.size === 0) {
                      return new Control_Monad_Rec_Class.Done(v.accum);
                  };
                  return new Control_Monad_Rec_Class.Loop({
                      accum: new Data_List_Types.Cons(v.arg, v.accum),
                      size: v.size - 1 | 0,
                      arg: f(v.arg)
                  });
              };
              return Control_Monad_Rec_Class.tailRec(go)({
                  accum: Data_List_Types.Nil.value,
                  size: n,
                  arg: x
              });
          };
  ...
  var predicateConditional = function (f) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at PRNG (line 127, column 1 - line 127, column 75): " + [ f.constructor.name, v.constructor.name ]);
      };
  };
  var nth = function (xs) {
      return function (i) {
  ...
  var randoms = function (n) {
      return function (r) {
          return Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return v.val;
          })(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(unfold(n)(prng)(r)));
      };
  };
  ...
  var draw = function (distribution) {
      return function (r0) {
          return function (r1) {
              var v = nth(distribution)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r0)(Data_Array.length(distribution)));
              if (v instanceof Singleton) {
                  return v.value0.option;
              };
              if (v instanceof Couple) {
                  var x = Data_Int.toNumber(r1) / 10000.0;
                  var $46 = x < Data_Rational.toNumber(v.value0.value0.probability);
                  if ($46) {
                      return v.value0.value0.option;
                  };
                  return v.value0.value1.option;
              };
              throw new Error("Failed pattern match at PRNG (line 199, column 3 - line 205, column 28): " + [ v.constructor.name ]);
          };
      };
  };
  ...
  var reshpeDiscreteDistribution = function (ps) {
      ...
      var initial = Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v) {
          return function (m) {
              var $55 = Data_Ord.greaterThan(Data_Ratio.ordRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(v.value1)(Data_Rational.fromInt(0));
              if ($55) {
      ...
      var go = function ($copy_cur) {
          ...
          function $tco_loop(cur) {
              var $58 = completeConditionals(cur);
              if ($58) {
                  $tco_done = true;
                  return cur;
              };
...
(function($PS) {
  ...
  var bin = function (k) {
      return function (v) {
          return {
              ...
              im: v.value1,
              freq: k,
              mag: $$Math.sqrt(v.value0 * v.value0 + v.value1 * v.value1),
              phase: $$Math.atan2(v.value1)(v.value0)
          };
      };
  };
  var sortByMagnitude = function (zs) {
      return Data_Array.sortBy(function (a) {
          return function (b) {
              return Data_Ord.compare(Data_Ord.ordNumber)(b.mag)(a.mag);
          };
      })(Data_Functor.map(Data_Functor.functorArray)(function (v) {
          return bin(v.index)(v.value);
  ...
  exports["unsafePeek"] = unsafePeek;
  exports["fft"] = fft;
  exports["sortByMagnitude"] = sortByMagnitude;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
(function($PS) {
  ...
  var runUnpure = function (unpure) {
      if (unpure instanceof GetFileText) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Web_HTML_HTMLInputElement.files(Data_Maybe.fromJust()(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_HTML_HTMLInputElement.fromEventTarget)(Web_Event_Event.target(unpure.value0))))))(function (mfs) {
              return Data_Functor.map(Effect_Aff.functorAff)(unpure.value1)(Data_Maybe.maybe(Control_Applicative.pure(Effect_Aff.applicativeAff)(""))(Web_File_FileReader_Aff.readAsText)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function ($48) {
                  return Data_Maybe.Just.create(Web_File_File.toBlob($48));
      ...
      throw new Error("Failed pattern match at Main (line 209, column 5 - line 222, column 20): " + [ unpure.constructor.name ]);
  };
  var rescale = function (n) {
      return function (lev) {
          return Data_Int.toNumber((2 * lev | 0) + 1 | 0) / Data_Int.toNumber(n) - 1.0;
      };
  };
  ...
  var probabilize = function (m) {
      ...
      return Data_Functor.map(Data_Functor.functorArray)(function (i) {
          ...
          if (v instanceof Data_Maybe.Just) {
              var $24 = Data_Ord.greaterThan(Data_Ratio.ordRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(s)(Data_Rational.fromInt(0));
              if ($24) {
          ...
          var $26 = Data_Ord.greaterThan(Data_Ratio.ordRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(s)(Data_Rational.fromInt(0));
          if ($26) {
  ...
  var quantize = function (n) {
      return function (x) {
          return rescale(n)(level(n)(x));
      };
  };
  var buildStochastic = function (arr) {
      return function (rnds) {
          return function (n) {
              return function (a) {
                  return Control_Monad_ST_Internal["for"](2)(n - 1 | 0)(function (i) {
                      return function __do() {
                          var n0 = Data_Complex_FFT.unsafePeek(i - 2 | 0)(a)();
                          var n1 = Data_Complex_FFT.unsafePeek(i - 1 | 0)(a)();
                          var r0 = nth(rnds)(2 * i | 0);
                          var r1 = nth(rnds)((2 * i | 0) + 1 | 0);
                          var n2 = PRNG.draw((function () {
                              var v = Data_Map_Internal.lookup(Data_Tuple.ordTuple(Data_Ord.ordInt)(Data_Ord.ordInt))(new Data_Tuple.Tuple(n0, n1))(arr);
                              if (v instanceof Data_Maybe.Just) {
                                  return v.value0;
                              };
                              return [ new PRNG.Singleton({
                                  option: Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(order)(2),
                                  probability: Data_Rational.fromInt(1)
                              }) ];
                          })())(r0)(r1);
                          return Data_Array_ST.poke(i)(n2)(a)();
                      };
                  });
              };
          };
  ...
  var generateStochastic = function (n) {
      return function (arr) {
          var rnds = PRNG.randoms(2 * n | 0)(PRNG.prng({
              gen: 0,
              val: 0,
              seed: 20200421
          }));
          return Data_Functor.map(Data_Functor.functorArray)(rescale(order))(Data_Array_ST.withArray(buildStochastic(arr)(rnds)(n))(Data_Array.replicate(n)(0))());
      };
  };
  var buildSpectral = function (bs) {
      return function (a) {
          return Control_Monad_ST_Internal["for"](0)(Data_Array.length(bs))(function (i) {
              var bin = nth(bs)(i);
              return Data_Array_ST.poke(bin.freq)(new Data_Complex.Cartesian(bin.re, bin.im))(a);
          });
      };
  };
  var generateSpectral = function (signal) {
      return function (n) {
          return function (bs) {
              return Data_Functor.map(Data_Functor.functorArray)(Data_Complex.real)(Data_Complex_FFT.fft(Data_Complex_FFT.Backward.value)(Data_Array_ST.withArray(buildSpectral(bs))(Data_Array.replicate(n)(Data_Semiring.zero(Data_Complex.semiringCartesian(Data_Ring.ringNumber))))()));
          };
      };
  };
  var processSpectral = function (str) {
      var signal = Data_Functor.map(Data_Functor.functorArray)(Global.readFloat)(Data_Array.filter(function (v) {
          return v !== "";
      })(Data_String_Common.split("\x0a")(str)));
      return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (a) {
          return function (b) {
              return Data_Show.show(Data_Show.showNumber)(a) + ("\x0a" + b);
          };
      })("")(generateSpectral(signal)(16384)(Data_Array.take(2000)(Data_Complex_FFT.sortByMagnitude(Data_Complex_FFT.fft(Data_Complex_FFT.Forward.value)(Data_Functor.map(Data_Functor.functorArray)(function (r) {
          return new Data_Complex.Cartesian(r, 0.0);
      })(signal))))));
  };
  var process = processSpectral;
  var update = function (s) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 163, column 1 - line 163, column 63): " + [ s.constructor.name, v.constructor.name ]);
      };
  };
  ...
  var processStochastic = function (str) {
      return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (a) {
          return function (b) {
              return Data_Show.show(Data_Show.showNumber)(a) + ("\x0a" + b);
          };
      })("")(generateStochastic(16384)(Data_Functor.map(Data_Map_Internal.functorMap)(PRNG.reshpeDiscreteDistribution)(buildMap(Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(Data_Functor.functorFn)(level(order))(Global.readFloat))(Data_Array.filter(function (v) {
          return v !== "";
      })(Data_String_Common.split("\x0a")(str)))))));
  };
  var app = {
  ...
  exports["buildStochastic"] = buildStochastic;
  exports["generateStochastic"] = generateStochastic;
  exports["buildSpectral"] = buildSpectral;
  exports["generateSpectral"] = generateSpectral;
  exports["processSpectral"] = processSpectral;
  exports["processStochastic"] = processStochastic;
