...
(function($PS) {
  ...
  var interLineCircle = new Intersectable(function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Data.Geometry.Plane (line 209, column 10 - line 215, column 55): " + [ Data_Unit.unit.constructor.name ]);
      };
  });
...
(function($PS) {
  ...
  var withCoord = function (c) {
      return function (p) {
          return c(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(p))(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(p));
      };
  };
  ...
  var arrowTip = function (v) {
      var v1 = Data_Geometry_Plane.vector(v.origin)(v.extremity);
      var v0 = Data_Geometry_Plane.Vector(Data_Sparse_Polynomial.monoPol(Data_Geometry_Plane.length(Data_Geometry_Plane.measurableVector)(v1))(0));
      var ang = $$Math.atan2(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedVector)(v1))(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedVector)(v1));
      var f = function (theta) {
          var v11 = Data_Geometry_Plane.rotated(theta)(Data_Geometry_Plane.Vector(Data_Sparse_Polynomial.monoPol(arrowLength)(0)));
          return Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(v.origin)(Data_Geometry_Plane.rotated(ang)(Data_Geometry_Plane.plus(Data_Geometry_Plane.summableVectorVector)(v11)(v0)));
      };
      return {
  ...
  var renderArc = new Render(function (v) {
      return function (v1) {
          var v2 = Data_Geometry_Plane.scale(v1.radius / Data_Geometry_Plane.length(Data_Geometry_Plane.measurableVector)(v1.extremity))(v1.extremity);
          var u = Data_Geometry_Plane.scale(v1.radius / Data_Geometry_Plane.length(Data_Geometry_Plane.measurableVector)(v1.origin))(v1.origin);
          var pO = Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(v1.center)(u);
          var pE = Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(v1.center)(v2);
          var b = (function () {
          ...
          var n = Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(pE)(Data_Geometry_Plane.scale(-a3)(Data_Geometry_Plane.normalTo(v1.extremity)));
          var a2 = (function () {
              if (v1.flipped) {
          ...
          var uv = Data_Geometry_Plane.plus(Data_Geometry_Plane.summableVectorVector)(u)(v2);
          var i = Data_Geometry_Plane.plus(Data_Geometry_Plane.summublePointVector)(v1.center)(Data_Geometry_Plane.scale((v1.radius * 0.8) / Data_Geometry_Plane.length(Data_Geometry_Plane.measurableVector)(uv))(uv));
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ path(v.strokeColor)(v.strokeWidth)(v.fillColor)([ withCoord(Halogen_Svg_Attributes.m(Halogen_Svg_Attributes.Abs.value))(pO), withCoord(Halogen_Svg_Attributes.a(Halogen_Svg_Attributes.Rel.value)(v1.radius)(v1.radius)(0.0)(a1)(a2))(Data_Geometry_Plane.point("")(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(pE) - Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(pO))(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(pE) - Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(pO))) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (str) {
              ...
              return [ text(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(i))(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(i))(v.textFill)(v.fontStyle)(str) ];
          })(v1.asOriented)));
      };
  });
  var renderSegment = new Render(function (v) {
      return function (v1) {
          var mid = Data_Geometry_Plane.middle("")(v1);
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ line(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1.origin))(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1.origin))(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(v1.extremity))(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(v1.extremity))(v.strokeColor)(v.strokeWidth) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (str) {
              var v2 = arrowTip(v1);
              ...
              return [ text(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(mid) + 10.0)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(mid) - 10.0)(v.textFill)(v.fontStyle)(str), text(Data_Geometry_Plane.abs(Data_Geometry_Plane.basedPoint)(mid) + 10.0)(Data_Geometry_Plane.ord(Data_Geometry_Plane.basedPoint)(mid) - 23.0)(v.textFill)(v.fontStyle)((function () {
                  var $80 = str === "";
                  if ($80) {
                      return "";
                  };
...
(function($PS) {
  ...
  var toPathCommand = function (v) {
      ...
      throw new Error("Failed pattern match at SimpleAbsSVG (line 19, column 1 - line 19, column 42): " + [ v.constructor.name ]);
  };
  var toGeometric = function (v) {
      if (v.value1.value1 instanceof L) {
          return Data_Maybe.Just.create(GeoS.create(Data_Geometry_Plane.segment(Data_Geometry_Plane.point("")(v.value0)(v.value1.value0))(Data_Geometry_Plane.point("")(v.value1.value1.value0)(v.value1.value1.value1))(Data_Maybe.Nothing.value)));
      };
      if (v.value1.value1 instanceof H) {
          return Data_Maybe.Just.create(GeoS.create(Data_Geometry_Plane.segment(Data_Geometry_Plane.point("")(v.value0)(v.value1.value0))(Data_Geometry_Plane.point("")(v.value1.value1.value0)(v.value1.value0))(Data_Maybe.Nothing.value)));
      };
      if (v.value1.value1 instanceof V) {
          return Data_Maybe.Just.create(GeoS.create(Data_Geometry_Plane.segment(Data_Geometry_Plane.point("")(v.value0)(v.value1.value0))(Data_Geometry_Plane.point("")(v.value0)(v.value1.value1.value0))(Data_Maybe.Nothing.value)));
      };
      if (v.value1.value1 instanceof A) {
          var c2 = Data_Geometry_Plane.circle(Data_Geometry_Plane.point("")(v.value1.value1.value2)(v.value1.value1.value3))(v.value1.value1.value0);
          var c1 = Data_Geometry_Plane.circle(Data_Geometry_Plane.point("")(v.value0)(v.value1.value0))(v.value1.value1.value0);
          var ms = Data_Geometry_Plane.meets(Data_Geometry_Plane.interCircleCircle)(c1)(c2);
          var center = (function () {
          ...
          return Control_Bind.bind(Data_Maybe.bindMaybe)(center)(function (c) {
              return Data_Maybe.Just.create(GeoA.create(Data_Geometry_Plane.arc(Data_Geometry_Plane.vector(c)(Data_Geometry_Plane.point("")(v.value0)(v.value1.value0)))(c)(Data_Geometry_Plane.vector(c)(Data_Geometry_Plane.point("")(v.value1.value1.value2)(v.value1.value1.value3)))(v.value1.value1.value0)(false)(!v.value1.value1.value1)(false)(Data_Maybe.Nothing.value)));
          });
      };
      return Data_Maybe.Nothing.value;
  };
  var simpleAbsRender = function (lp) {
      var f = function (v) {
          ...
          throw new Error("Failed pattern match at SimpleAbsSVG (line 69, column 7 - line 69, column 44): " + [ v.constructor.name ]);
      };
      var arr = Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(toGeometric)(lp));
  ...
  var longPath = function (shape) {
      var set = function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at SimpleAbsSVG (line 32, column 11 - line 32, column 44): " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
      var oris = (function () {
