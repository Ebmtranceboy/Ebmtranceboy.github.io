...
(function($PS) {
  ...
  var GotFocus = (function () {
      function GotFocus(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      GotFocus.create = function (value0) {
          return function (value1) {
              return new GotFocus(value0, value1);
          };
      };
      return GotFocus;
  })();
  var LostFocus = (function () {
      function LostFocus(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      LostFocus.create = function (value0) {
          return function (value1) {
              return new LostFocus(value0, value1);
          };
      };
      return LostFocus;
  })();
      ...
      return function (period) {
          return function (fluid) {
              return function (n) {
                  ...
                  return Data_Maybe.fromMaybe(0.0)(mx);
              };
          };
      };
  };
  ...
  var prove = function (str) {
      ...
      var $$int = function ($116) {
          return Data_Int.round(Global.readFloat($116));
      };
  ...
  var onEnter = function (a) {
      return Halogen_HTML_Events.onKeyDown(function (ev) {
          var $76 = Web_UIEvent_KeyboardEvent.key(ev) === "Enter";
          if ($76) {
  ...
  var inputFluid = function (state) {
      return function (period) {
          return function (fluid) {
              return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Events.onValueInput((function () {
                  var $117 = UpdateFluid.create(function (dictStrong) {
                      return period(dictStrong);
                  })(function (dictStrong) {
                      return fluid(dictStrong);
                  });
                  return function ($118) {
                      return Data_Maybe.Just.create($117($118));
                  };
              })()), Halogen_HTML_Events.onFocus(Data_Function["const"](Data_Maybe.Just.create(new GotFocus(function (dictStrong) {
                  return period(dictStrong);
              }, function (dictStrong) {
                  return fluid(dictStrong);
              })))), Halogen_HTML_Events.onBlur(Data_Function["const"](Data_Maybe.Just.create(new LostFocus(function (dictStrong) {
                  return period(dictStrong);
              }, function (dictStrong) {
                  return fluid(dictStrong);
              })))) ])((function () {
                  var $77 = safeAt(state)(function (dictStrong) {
                      return period(dictStrong);
                  })(function (dictStrong) {
                      return fluid(dictStrong);
                  })(0) < 0.0;
                  if ($77) {
                      return [ Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(safeAt(state)(function (dictStrong) {
                          return period(dictStrong);
                      })(function (dictStrong) {
                          return fluid(dictStrong);
                      })(state.emplacement))) ];
  ...
  var fromStorage = function __do() {
      var storedModel = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage))((function () {
          var $119 = Data_Functor.map(Effect.functorEffect)(function (v) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(v)((function () {
                  var $122 = Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "base";
                  ...
                  return function ($123) {
                      return Data_Either.hush($122($123));
                  };
              })());
          });
          var $120 = Web_Storage_Storage.getItem(storageKey);
          return function ($121) {
              return $119($120($121));
          };
      })())();
  ...
  var empl = function (n) {
      return [ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.name("emplacements"), Halogen_HTML_Properties.id_("empl" + Data_Show.show(Data_Show.showInt)(n)), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(n)), Halogen_HTML_Events.onValueInput(function ($124) {
          return Data_Maybe.Just.create(UpdateEmplacement.create($124));
      ...
      return function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(timer(dictMonadAff)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(fromStorage))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(dictMonadAff)(new LostFocus(function (dictStrong) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(dictMonadAff)(new LostFocus(function (dictStrong) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(dictMonadAff)(new LostFocus(function (dictStrong) {
                                  ...
                                  return handleAction(dictMonadAff)(new LostFocus(function (dictStrong) {
                                      return _newer(dictStrong);
                                  }, function (dictStrong) {
                                      return _edf(dictStrong);
                                  }));
          ...
          if (v instanceof UpdateEmplacement) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $91.emplacement = Data_Int.round(Global.readFloat(v.value0));
                  return $91;
              });
          };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.over(v.value0(Data_Profunctor_Strong.strongFn))(Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(state.emplacement)(Data_Lens_Internal_Wander.wanderFunction))(Data_Lens_Setter.set(v.value1(Data_Profunctor_Strong.strongFn))(Global.readFloat(v.value2))))))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
                          var $125 = Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()));
                          return function ($126) {
                              return $125(toStorage($126));
                          };
                      })());
                  });
              });
          };
          if (v instanceof GotFocus) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.over(v.value0(Data_Profunctor_Strong.strongFn))(Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(0)(Data_Lens_Internal_Wander.wanderFunction))(Data_Lens_Setter.set(v.value1(Data_Profunctor_Strong.strongFn))(1.0))));
          };
          if (v instanceof LostFocus) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.over(v.value0(Data_Profunctor_Strong.strongFn))(Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(0)(Data_Lens_Internal_Wander.wanderFunction))(Data_Lens_Setter.set(v.value1(Data_Profunctor_Strong.strongFn))(-1.0))));
          };
          if (v instanceof UpdateBase) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $102.baseDate = prove(v.value0);
                  return $102;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
                      var $127 = Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()));
                      return function ($128) {
                          return $127(toStorage($128));
                      };
                  })());
              });
          };
          if (v instanceof UpdateNewer) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $106.newerDate = prove(v.value0);
                  return $106;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
                      var $129 = Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()));
                      return function ($130) {
                          return $129(toStorage($130));
                      };
                  })());
              });
          };
          if (v instanceof AddTodo) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(update))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
                      var $131 = Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()));
                      return function ($132) {
                          return $131(toStorage($132));
                      };
                  })());
              });
          };
  ...
  var render = function (state) {
      ...
      var consoEdf = (safeAt(state)(function (dictStrong) {
          return _newer(dictStrong);
      })(function (dictStrong) {
          return _edf(dictStrong);
      })(state.emplacement) - safeAt(state)(function (dictStrong) {
          return _base(dictStrong);
      })(function (dictStrong) {
          return _edf(dictStrong);
      ...
      return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Started " + (Data_Show.show(Data_Show.showInt)(state.elapsed) + " seconds ago.")) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(empl)(Data_Array.range(1)(8))))([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Emplacement " + Data_Show.show(Data_Show.showInt)(state.emplacement)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Base : " + prettyDate(state.baseDate)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputDate.value), Halogen_HTML_Properties.value(dateValuesToValue(state.baseDate)), Halogen_HTML_Events.onValueInput(function ($133) {
          ...
          return _eau(dictStrong);
      })), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Edf : ") ]), Halogen_HTML_Elements.input(inputFluid(state)(function (dictStrong) {
          return _base(dictStrong);
      })(function (dictStrong) {
          return _edf(dictStrong);
      })), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Newer : " + prettyDate(state.newerDate)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputDate.value), Halogen_HTML_Properties.value(dateValuesToValue(state.newerDate)), Halogen_HTML_Events.onValueInput(function ($134) {
          return Data_Maybe.Just.create(UpdateNewer.create($134));
      }) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Eau : ") ]), Halogen_HTML_Elements.input(inputFluid(state)(function (dictStrong) {
          return _newer(dictStrong);
      })(function (dictStrong) {
          return _eau(dictStrong);
  ...
  exports["GotFocus"] = GotFocus;
  exports["LostFocus"] = LostFocus;
