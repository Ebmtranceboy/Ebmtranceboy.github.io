...
(function($PS) {
  ...
  var UpdateFluid = (function () {
      function UpdateFluid(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      UpdateFluid.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new UpdateFluid(value0, value1, value2);
              };
          };
      };
      return UpdateFluid;
  ...
  var safeAt = function (xs) {
      return function (ex) {
          return function (n) {
              ...
              return Data_Maybe.maybe(0.0)(ex)(mx);
          };
      };
  };
  var raz = {
  ...
  var prove = function (str) {
      ...
      var $$int = function ($93) {
          return Data_Int.round(Global.readFloat($93));
      };
  ...
  var onEnter = function (a) {
      return Halogen_HTML_Events.onKeyDown(function (ev) {
          var $58 = Web_UIEvent_KeyboardEvent.key(ev) === "Enter";
          if ($58) {
  ...
  var fromStorage = function __do() {
      var storedModel = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage))((function () {
          var $94 = Data_Functor.map(Effect.functorEffect)(function (v) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(v)((function () {
                  var $97 = Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "base";
                  ...
                  return function ($98) {
                      return Data_Either.hush($97($98));
                  };
              })());
          });
          var $95 = Web_Storage_Storage.getItem(storageKey);
          return function ($96) {
              return $94($95($96));
          };
      })())();
      ...
      throw new Error("Failed pattern match at Main (line 130, column 10 - line 138, column 10): " + [ storedModel.constructor.name ]);
  };
      ...
      return function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(timer(dictMonadAff)))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(fromStorage))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM));
              });
          };
          ...
          if (v instanceof UpdateEmplacement) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $66.emplacement = Data_Int.round(Global.readFloat(v.value0));
                  return $66;
              });
          };
          if (v instanceof UpdateFluid) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.over(v.value0(Data_Profunctor_Strong.strongFn))(Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(state.emplacement)(Data_Lens_Internal_Wander.wanderFunction))(Data_Lens_Setter.set(v.value1(Data_Profunctor_Strong.strongFn))(Global.readFloat(v.value2))))))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
                          var $99 = Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()));
                          return function ($100) {
                              return $99(toStorage($100));
                          };
                      })());
                  });
              });
          ...
          if (v instanceof UpdateBase) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $73.baseDate = prove(v.value0);
                  return $73;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
                      var $101 = Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()));
                      return function ($102) {
                          return $101(toStorage($102));
                      };
                  })());
              });
          };
          if (v instanceof UpdateNewer) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $77.newerDate = prove(v.value0);
                  return $77;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
                      var $103 = Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()));
                      return function ($104) {
                          return $103(toStorage($104));
                      };
                  })());
              });
          };
          if (v instanceof AddTodo) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(update))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
                      var $105 = Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()));
                      return function ($106) {
                          return $105(toStorage($106));
                      };
                  })());
              });
          };
          ...
          if (v instanceof Tick) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  var $82 = {};
                  for (var $83 in state) {
                      if ({}.hasOwnProperty.call(state, $83)) {
                          $82[$83] = state[$83];
                      };
                  };
                  $82.elapsed = state.elapsed + 1 | 0;
                  return $82;
              });
          };
          throw new Error("Failed pattern match at Main (line 149, column 1 - line 151, column 54): " + [ v.constructor.name ]);
      };
  };
  var empl = function (n) {
      return [ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.name("emplacements"), Halogen_HTML_Properties.id_("empl" + Data_Show.show(Data_Show.showInt)(n)), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(n)), Halogen_HTML_Events.onValueInput(function ($107) {
          return Data_Maybe.Just.create(UpdateEmplacement.create($107));
  ...
  var render = function (state) {
      var addNote = (function () {
          ...
          return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Press Enter to add: " + state.name) ]);
      })();
      var consoEdf = (safeAt(state.newer)(function (v) {
          return v.edf;
      })(state.emplacement) - safeAt(state.base)(function (v) {
          return v.edf;
      })(state.emplacement)) * 6.7e-2;
      var consoEau = (safeAt(state.newer)(function (v) {
          return v.eau;
      })(state.emplacement) - safeAt(state.base)(function (v) {
          return v.eau;
      ...
      var consoEmpl = v * 2.0;
      return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Started " + (Data_Show.show(Data_Show.showInt)(state.elapsed) + " seconds ago.")) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(empl)(Data_Array.range(1)(8))))([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Emplacement " + Data_Show.show(Data_Show.showInt)(state.emplacement)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Base : " + prettyDate(state.baseDate)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputDate.value), Halogen_HTML_Properties.value(dateValuesToValue(state.baseDate)), Halogen_HTML_Events.onValueInput(function ($108) {
          return Data_Maybe.Just.create(UpdateBase.create($108));
      }) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Eau : ") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(safeAt(state.base)(function (v1) {
          return v1.eau;
      })(state.emplacement))), Halogen_HTML_Events.onValueInput((function () {
          var $109 = UpdateFluid.create(function (dictStrong) {
              return _base(dictStrong);
          })(function (dictStrong) {
              return _eau(dictStrong);
          });
          return function ($110) {
              return Data_Maybe.Just.create($109($110));
          };
      })()) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Edf : ") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(safeAt(state.base)(function (v1) {
          return v1.edf;
      })(state.emplacement))), Halogen_HTML_Events.onValueInput((function () {
          var $111 = UpdateFluid.create(function (dictStrong) {
              return _base(dictStrong);
          })(function (dictStrong) {
              return _edf(dictStrong);
          });
          return function ($112) {
              return Data_Maybe.Just.create($111($112));
          };
      })()) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Newer : " + prettyDate(state.newerDate)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputDate.value), Halogen_HTML_Properties.value(dateValuesToValue(state.newerDate)), Halogen_HTML_Events.onValueInput(function ($113) {
          return Data_Maybe.Just.create(UpdateNewer.create($113));
      }) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Eau : ") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(safeAt(state.newer)(function (v1) {
          return v1.eau;
      })(state.emplacement))), Halogen_HTML_Events.onValueInput((function () {
          var $114 = UpdateFluid.create(function (dictStrong) {
      ...
      })()) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Edf : ") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(safeAt(state.newer)(function (v1) {
          return v1.edf;
      })(state.emplacement))), Halogen_HTML_Events.onValueInput((function () {
          var $116 = UpdateFluid.create(function (dictStrong) {
              return _newer(dictStrong);
          })(function (dictStrong) {
              return _edf(dictStrong);
          });
      ...
      })()) ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Conso Eau: " + Data_Show.show(Data_Show.showNumber)(consoEau)) ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Conso Edf: " + Data_Show.show(Data_Show.showNumber)(consoEdf)) ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Co\xfbt Emplacement : " + Data_Show.show(Data_Show.showNumber)(consoEmpl)) ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Total: " + Data_Show.show(Data_Show.showNumber)(consoEau + consoEdf + consoEmpl)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Anything to add?") ]), addNote, Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.value(state.name), Halogen_HTML_Properties.placeholder("type note"), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Events.onValueInput(function ($118) {
          return Data_Maybe.Just.create(UpdateName.create($118));
  ...
  exports["UpdateFluid"] = UpdateFluid;
