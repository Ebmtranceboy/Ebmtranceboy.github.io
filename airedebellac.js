...
(function($PS) {
  ...
  var render = function (state) {
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Started " + (Data_Show.show(Data_Show.showInt)(state.elapsed) + " seconds ago.")) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Today : " + Data_Show.show(Data_Maybe.showMaybe(Data_Date.showDate))(today)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Base : " + Data_Show.show(Data_Maybe.showMaybe(Data_DateTime.showDateTime))(valuesToDate(state.baseDate))) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputDate.value), Halogen_HTML_Events.onValueInput(function ($40) {
          return Data_Maybe.Just.create(UpdateDate.create($40));
      }) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.name("emplacements"), Halogen_HTML_Properties.id_("empl1"), Halogen_HTML_Properties.value("1"), Halogen_HTML_Events.onValueInput(function ($41) {
          return Data_Maybe.Just.create(UpdateEmplacement.create($41));
      }) ]), Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("empl1") ])([ Halogen_HTML_Core.text("1") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.name("emplacements"), Halogen_HTML_Properties.id_("empl2"), Halogen_HTML_Properties.value("2"), Halogen_HTML_Events.onValueInput(function ($42) {
          return Data_Maybe.Just.create(UpdateEmplacement.create($42));
      }) ]), Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("empl2") ])([ Halogen_HTML_Core.text("2") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Emplacement " + Data_Show.show(Data_Show.showInt)(state.emplacement)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("What is your name?") ]), hello, Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.value(state.name), Halogen_HTML_Properties.placeholder("type note"), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Events.onValueInput(function ($43) {
          return Data_Maybe.Just.create(UpdateName.create($43));
  ...
  var fromStorage = function __do() {
      var storedModel = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage))((function () {
          var $44 = Data_Functor.map(Effect.functorEffect)(function (v) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(v)((function () {
                  var $47 = Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "baseDate";
                  ...
                  return function ($48) {
                      return Data_Either.hush($47($48));
                  };
              })());
          });
          var $45 = Web_Storage_Storage.getItem(storageKey);
          return function ($46) {
              return $44($45($46));
          };
      })())();
