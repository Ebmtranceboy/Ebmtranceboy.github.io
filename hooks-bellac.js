...
(function($PS) {
  ...
  exports["IxApplicative"] = IxApplicative;
  exports["ipure"] = ipure;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Data.Indexed"] = $PS["Data.Indexed"] || {};
  var exports = $PS["Data.Indexed"];
  var Control_Applicative = $PS["Control.Applicative"];
  ...
  var ixApplicativeIndexed = function (dictApplicative) {
      return new Control_Applicative_Indexed.IxApplicative(function () {
          ...
          var $33 = Control_Applicative.pure(dictApplicative);
          return function ($34) {
              return Indexed($33($34));
          };
      })());
  };
  exports["Indexed"] = Indexed;
  exports["ixApplicativeIndexed"] = ixApplicativeIndexed;
  exports["ixBindIndexed"] = ixBindIndexed;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  ...
  var Control_Monad_Free = $PS["Control.Monad.Free"];
  var Data_Indexed = $PS["Data.Indexed"];                
  var Hooked = function (x) {
      return x;
  };                                                                                   
  var ixBindIndexed = Data_Indexed.ixBindIndexed(Control_Monad_Free.freeBind);   
  var ixApplicativeIndexed = Data_Indexed.ixApplicativeIndexed(Control_Monad_Free.freeApplicative);
...
(function($PS) {
  ...
  var wrap = function (dictNewtype) {
      return function (hook) {
          return Control_Bind_Indexed.ibind(Halogen_Hooks_Hook.ixBindIndexed)(hook)((function () {
              var $13 = Control_Applicative.pure(Control_Monad_Free.freeApplicative);
              return function ($14) {
                  return Halogen_Hooks_Hook.Hooked(Data_Indexed.Indexed($13($14)));
              };
          })());
      };
  };
  var useTickEffect = function (memos) {
      return function (fn) {
          return Halogen_Hooks_Hook.Hooked(Data_Indexed.Indexed(Control_Monad_Free.liftF(new Halogen_Hooks_Internal_UseHookF.UseEffect(new Data_Maybe.Just(memos), fn, Data_Unit.unit))));
      };
  };
  var useState = function (initialState) {
      ...
      return Halogen_Hooks_Hook.Hooked(Data_Indexed.Indexed(Control_Monad_Free.liftF(new Halogen_Hooks_Internal_UseHookF.UseState(initialState$prime, $$interface))));
  };
  var useLifecycleEffect = function (fn) {
      return Halogen_Hooks_Hook.Hooked(Data_Indexed.Indexed(Control_Monad_Free.liftF(new Halogen_Hooks_Internal_UseHookF.UseEffect(Data_Maybe.Nothing.value, fn, Data_Unit.unit))));
  };
...
(function($PS) {
  ...
  var monadEffectHookM = function (dictMonadEffect) {
      return new Effect_Class.MonadEffect(function () {
          ...
          var $81 = Effect_Class.liftEffect(dictMonadEffect);
          return function ($82) {
              return HookM(Control_Monad_Free.liftF(Lift.create($81($82))));
          };
      })());
  };
  var modify = function (identifier) {
      return function (f) {
          var f$prime = function ($85) {
              return Halogen_Hooks_Internal_Types.toStateValue(f(Halogen_Hooks_Internal_Types.fromStateValue($85)));
          };
  ...
  var modify_ = function (identifier) {
      var $88 = Data_Functor.map(functorHookM)(Data_Function["const"](Data_Unit.unit));
      var $89 = modify(identifier);
      return function ($90) {
          return $88($89($90));
      };
  };
...
(function($PS) {
  ...
  var newtypeHookState = new Data_Newtype.Newtype(function (n) {
      return n;
  }, HookState);
  ...
  exports["newtypeHookState"] = newtypeHookState;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  ...
  var modifyState_ = function (fn) {
      return Control_Bind.bind(Control_Monad_Free.freeBind)(Control_Monad_Free.liftF(new Halogen_Query_HalogenM.State(function (state) {
          ...
          return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Effect_Unsafe.unsafePerformEffect(Effect_Ref.modify_(fn)(v.stateRef)));
      });
  };
  var getState = Control_Bind.bind(Control_Monad_Free.freeBind)(Control_Monad_Free.liftF(new Halogen_Query_HalogenM.State(function (state) {
      return new Data_Tuple.Tuple(state, state);
  })))(function (v) {
      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Effect_Unsafe.unsafePerformEffect(Effect_Ref.read(v.stateRef)));
  });
  var interpretHook = function (runHookM) {
              ...
              return function (hookFn) {
                  return function (v) {
                      if (v instanceof Halogen_Hooks_Internal_UseHookF.UseState) {
                          if (reason instanceof Halogen_Hooks_Internal_Eval_Types.Initialize) {
                              return Control_Bind.bind(Control_Monad_Free.freeBind)(getState)(function (v1) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(modifyState_(function (v2) {
                                      return {
                                          input: v2.input,
                          ...
                          return Control_Bind.bind(Control_Monad_Free.freeBind)(getState)(function (v1) {
                              ...
                              var nextIndex = (function () {
                                  var $57 = (v1.stateCells.index + 1 | 0) < Data_Array.length(v1.stateCells.queue);
                                  if ($57) {
                                      return v1.stateCells.index + 1 | 0;
                                  };
                                  return 0;
                              })();
                      ...
                      if (v instanceof Halogen_Hooks_Internal_UseHookF.UseQuery) {
                          var handler$prime = function ($166) {
                              return v.value1(Halogen_Hooks_Internal_Types.toQueryValue($166));
                          };
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(modifyState_(function (v1) {
                              return {
                                  input: v1.input,
                      ...
                      if (v instanceof Halogen_Hooks_Internal_UseHookF.UseEffect) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)((function () {
                              if (reason instanceof Halogen_Hooks_Internal_Eval_Types.Initialize) {
                                  var $$eval = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(runHookM(runHook(Halogen_Hooks_Internal_Eval_Types.Queued.value))(v.value1))(function (mbFinalizer) {
                                      ...
                                      var newQueue = function (state) {
                                          return Data_Array.snoc(state.effectCells.queue)(new Data_Tuple.Tuple(v.value0, finalizer));
                                      };
                                      return Halogen_Query_HalogenM.HalogenM(modifyState_(function (st) {
                                          return {
                                              input: st.input,
                                              componentRef: st.componentRef,
                                              queryFn: st.queryFn,
                                              evalQueue: st.evalQueue,
                                  ...
                                  return modifyState_(function (st) {
                                      return {
                                          input: st.input,
                                          componentRef: st.componentRef,
                                          queryFn: st.queryFn,
                                          evalQueue: Data_Array.snoc(st.evalQueue)($$eval),
                                          stateCells: st.stateCells,
                                          effectCells: st.effectCells,
                                          memoCells: st.memoCells,
                                          refCells: st.refCells,
                                          stateDirty: st.stateDirty
                                      };
                              ...
                              if (reason instanceof Halogen_Hooks_Internal_Eval_Types.Step) {
                                  return Control_Bind.bind(Control_Monad_Free.freeBind)(getState)(function (v1) {
                                      ...
                                      if (v.value0 instanceof Data_Maybe.Just && v2.value0 instanceof Data_Maybe.Just) {
                                          ...
                                          var $73 = Foreign_Object.isEmpty(memos$prime["new"].memos) || Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean)))(memos$prime["new"].eq)(memos$prime.old.memos)(memos$prime["new"].memos);
                                          if ($73) {
                                              var $$eval = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(runHookM(runHook(Halogen_Hooks_Internal_Eval_Types.Queued.value))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(v2.value1)(function () {
                                                  return v.value1;
                                              })))(function (mbFinalizer) {
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.HalogenM(getState))(function (v3) {
                                                      ...
                                                      return Halogen_Query_HalogenM.HalogenM(modifyState_(function (v4) {
                                                          return {
                                                              input: v4.input,
                                          ...
                                          return modifyState_(function (v3) {
                                              return {
                                                  input: v3.input,
                              ...
                              if (reason instanceof Halogen_Hooks_Internal_Eval_Types.Finalize) {
                                  return Control_Bind.bind(Control_Monad_Free.freeBind)(getState)(function (v1) {
                                      var nextIndex = (function () {
                                          var $85 = (v1.effectCells.index + 1 | 0) < Data_Array.length(v1.effectCells.queue);
                                          if ($85) {
                                              return v1.effectCells.index + 1 | 0;
                                          };
                                          return 0;
                                      ...
                                      var v2 = unsafeGetCell(v1.effectCells.index)(v1.effectCells.queue);
                                      var finalizeHook = runHookM(runHook(Halogen_Hooks_Internal_Eval_Types.Queued.value))(v2.value1);
                                      return modifyState_(function (st) {
                                          return {
                                              input: st.input,
                                              componentRef: st.componentRef,
                                              queryFn: st.queryFn,
                                              evalQueue: Data_Array.snoc(st.evalQueue)(finalizeHook),
                                              stateCells: st.stateCells,
                                              effectCells: {
                                                  queue: st.effectCells.queue,
                                                  index: nextIndex
                              ...
                              throw new Error("Failed pattern match at Halogen.Hooks.Internal.Eval (line 126, column 5 - line 200, column 12): " + [ reason.constructor.name ]);
                          })())(function () {
                              return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(v.value2);
                          });
                      };
                      if (v instanceof Halogen_Hooks_Internal_UseHookF.UseMemo) {
                          ...
                          return Control_Bind.bind(Control_Monad_Free.freeBind)(getState)(function (v1) {
                              var nextIndex = (function () {
                                  var $100 = (v1.memoCells.index + 1 | 0) < Data_Array.length(v1.memoCells.queue);
                                  if ($100) {
                                      return v1.memoCells.index + 1 | 0;
                                  };
                                  return 0;
                              })();
                              var m = (function () {
                                  var v2 = Data_Bifunctor.bimap(Data_Tuple.bifunctorTuple)(Halogen_Hooks_Internal_Types.fromMemoValues)(Halogen_Hooks_Internal_Types.fromMemoValue)(unsafeGetCell(v1.memoCells.index)(v1.memoCells.queue));
                              ...
                              var $104 = Foreign_Object.isEmpty(m["new"]) || !m.eq(m["new"])(m.old);
                              if ($104) {
                                  var newValue = v.value1(Data_Unit.unit);
                      ...
                      if (v instanceof Halogen_Hooks_Internal_UseHookF.UseRef) {
                          ...
                          return Control_Bind.bind(Control_Monad_Free.freeBind)(getState)(function (v1) {
                              ...
                              var nextIndex = (function () {
                                  var $116 = (v1.refCells.index + 1 | 0) < Data_Array.length(v1.refCells.queue);
                                  if ($116) {
                                      return v1.refCells.index + 1 | 0;
                                  };
                                  return 0;
                              })();
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(modifyState_(function (v2) {
                      ...
                      throw new Error("Failed pattern match at Halogen.Hooks.Internal.Eval (line 93, column 48 - line 264, column 39): " + [ v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var mkEval = function (inputEq) {
      return function (runHookM) {
          return function (runHook) {
              return function (hookFn) {
                  var runHookAndEffects = function (reason) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(runHook(reason)(hookFn))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(getState)(function (v) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(!Data_Array["null"](v.evalQueue))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.HalogenM(modifyState_(function (v1) {
                                  return {
                                      input: v1.input,
                                      componentRef: v1.componentRef,
                                      queryFn: v1.queryFn,
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.sequence_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(v.evalQueue))(function () {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(getState)(function (v1) {
                                          ...
                                          return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v1.stateDirty && initializeOrStepReason)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(runHookAndEffects(Halogen_Hooks_Internal_Eval_Types.Step.value)));
                                      });
                                  });
                              })))(function () {
                                  return Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                      var $167 = Data_Newtype.unwrap(Halogen_Hooks_Internal_Eval_Types.newtypeHookState);
                                      return function ($168) {
                                          return (function (v1) {
                                              return v1.result;
                                          })($167($168));
                  ...
                  return function (v) {
                      if (v instanceof Halogen_Query_HalogenQ.Initialize) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(runHookAndEffects(Halogen_Hooks_Internal_Eval_Types.Initialize.value))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
                      };
                      if (v instanceof Halogen_Query_HalogenQ.Query) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(getState)(function (v1) {
                              if (v1.queryFn instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Data_Unit.unit));
                              };
                              if (v1.queryFn instanceof Data_Maybe.Just) {
                                  return runHookM(runHookAndEffects(Halogen_Hooks_Internal_Eval_Types.Step.value))(Data_Coyoneda.unCoyoneda(function (g) {
                                      var $169 = Data_Functor.map(Halogen_Hooks_HookM.functorHookM)(Data_Maybe.maybe(v.value1(Data_Unit.unit))(g));
                                      var $170 = Halogen_Hooks_Internal_Eval_Types.fromQueryFn(v1.queryFn.value0);
                                      return function ($171) {
                                          return $169($170($171));
                                      };
                                  })(v.value0));
                              };
                              throw new Error("Failed pattern match at Halogen.Hooks.Internal.Eval (line 45, column 5 - line 50, column 81): " + [ v1.queryFn.constructor.name ]);
                          });
                      };
                      if (v instanceof Halogen_Query_HalogenQ.Action) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(runHookM(runHookAndEffects(Halogen_Hooks_Internal_Eval_Types.Step.value))(v.value0))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      };
                      if (v instanceof Halogen_Query_HalogenQ.Receive) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(getState)(function (v1) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.unless(Halogen_Query_HalogenM.applicativeHalogenM)(inputEq(v1.input)(v.value0))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.HalogenM(modifyState_(function (v2) {
                                  return {
                                      input: v.value0,
                                      componentRef: v2.componentRef,
                                      queryFn: v2.queryFn,
                                  ...
                                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(runHookAndEffects(Halogen_Hooks_Internal_Eval_Types.Step.value));
                              })))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                          });
                      ...
                      if (v instanceof Halogen_Query_HalogenQ.Finalize) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(runHookAndEffects(Halogen_Hooks_Internal_Eval_Types.Finalize.value))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
                      };
                      throw new Error("Failed pattern match at Halogen.Hooks.Internal.Eval (line 38, column 42 - line 67, column 11): " + [ v.constructor.name ]);
                  };
              };
          };
      };
      ...
      return function (v1) {
          var interpretHalogenHook = function (v2) {
              if (v2 instanceof Halogen_Hooks_HookM.Modify) {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(getState)(function (state) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)((function () {
                          var v3 = Unsafe_Reference.unsafeRefEq(state.componentRef)(v2.value0.value0);
                          if (v3) {
                              return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Unit.unit);
                          };
                          ...
                          var current = unsafeGetCell(v2.value0.value1)(state.stateCells.queue);
                          var next = v2.value1(current);
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)((function () {
                              var v3 = Unsafe_Reference.unsafeRefEq(current)(next);
                              if (v3) {
                                  return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Unit.unit);
                              };
                              var newQueue = unsafeSetCell(v2.value0.value1)(next);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(modifyState_(function (v4) {
                                  return {
                                      input: v4.input,
                                      componentRef: v4.componentRef,
                                      queryFn: v4.queryFn,
                                      evalQueue: v4.evalQueue,
                                      stateCells: {
                                          queue: newQueue(state.stateCells.queue),
                                          index: v4.stateCells.index
                                      },
              ...
              if (v2 instanceof Halogen_Hooks_HookM.Par) {
                  return Control_Monad_Free.liftF(Halogen_Query_HalogenM.Par.create(Control_Applicative_Free.retractFreeAp(Halogen_Query_HalogenM.applicativeHalogenAp)(Control_Applicative_Free.hoistFreeAp((function () {
                      var $172 = evalHookM(v);
                      return function ($173) {
                          return Halogen_Query_HalogenM.HalogenAp(Control_Applicative_Free.liftFreeAp($172($173)));
                      };
                  })())(v2.value0))));
              };
              ...
              throw new Error("Failed pattern match at Halogen.Hooks.Internal.Eval (line 273, column 26 - line 337, column 31): " + [ v2.constructor.name ]);
          };
          return Halogen_Query_HalogenM.HalogenM(Control_Monad_Free.substFree(interpretHalogenHook)(v1));
      };
  };
  exports["mkEval"] = mkEval;
  exports["interpretHook"] = interpretHook;
...
(function($PS) {
  ...
  var memoComponent = function (eqInput) {
      return function (inputHookFn) {
          var interpretUseHookFn = function (runHookM) {
              return function (reason) {
                  return function (hookFn) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Hooks_Internal_Eval.getState)(function (v) {
                          var v1 = hookFn(v.input);
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.HalogenM(Control_Monad_Free.substFree(Halogen_Hooks_Internal_Eval.interpretHook(runHookM)(function (r) {
                              return interpretUseHookFn(runHookM)(r)(hookFn);
                          })(reason)(hookFn))(v1)))(function (a) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Newtype.over(Halogen_Hooks_Internal_Eval_Types.newtypeHookState)(Halogen_Hooks_Internal_Eval_Types.newtypeHookState)(Halogen_Hooks_Internal_Eval_Types.HookState)(function (v2) {
                                  return {
                                      result: a,
          ...
          return Halogen_Component.mkComponent({
              ...
              "eval": (function () {
                  var $11 = Halogen_Hooks_Internal_Eval_Types.toHalogenM(slotToken)(outputToken);
                  var $12 = Halogen_Hooks_Internal_Eval.mkEval(eqInput)(Halogen_Hooks_Internal_Eval.evalHookM)(interpretUseHookFn(Halogen_Hooks_Internal_Eval.evalHookM))(hookFn);
                  return function ($13) {
                      return $11($12($13));
                  };
              })()
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Hooks.UseInitializer"] = $PS["Hooks.UseInitializer"] || {};
  var exports = $PS["Hooks.UseInitializer"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Newtype = $PS["Data.Newtype"];
  ...
  var Halogen_Hooks_HookM = $PS["Halogen.Hooks.HookM"];                
  var UseInitializer = function (x) {
      return x;
  };
  var newtypeUseInitializer = new Data_Newtype.Newtype(function (n) {
      return n;
  }, UseInitializer);
  var useInitializer = function (initializer) {
      return Halogen_Hooks.wrap(newtypeUseInitializer)(Halogen_Hooks.useLifecycleEffect(Control_Apply.applySecond(Halogen_Hooks_HookM.applyHookM)(initializer)(Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Nothing.value))));
  };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Hooks.UseLocalStorage"] = $PS["Hooks.UseLocalStorage"] || {};
  var exports = $PS["Hooks.UseLocalStorage"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var Halogen_Hooks_Hook = $PS["Halogen.Hooks.Hook"];
  var Halogen_Hooks_HookM = $PS["Halogen.Hooks.HookM"];
  var Hooks_UseInitializer = $PS["Hooks.UseInitializer"];
  var Web_HTML = $PS["Web.HTML"];
  var Web_HTML_Window = $PS["Web.HTML.Window"];
  ...
  var newtypeUseLocalStorage = new Data_Newtype.Newtype(function (n) {
      return n;
  }, UseLocalStorage);
  var useLocalStorage = function (dictMonadEffect) {
      return function (dictEq) {
          return function (v) {
              var useWriteStorage = function (deps) {
                  return Halogen_Hooks.captures(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                      return "value";
                  }))(dictEq))()(new Data_Symbol.IsSymbol(function () {
                      return "key";
                  }))(Data_Eq.eqString)))(deps)(Halogen_Hooks.useTickEffect)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(function __do() {
                      var storage = Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.localStorage)(Web_HTML.window)();
                      return Web_Storage_Storage.setItem(deps.key)(v.toJson(deps.value))(storage)();
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Nothing.value);
                  }));
              };
              return Halogen_Hooks.wrap(newtypeUseLocalStorage)(Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useState(v.defaultValue))(function (v1) {
                  return Halogen_Hooks.discard(Halogen_Hooks_Hook.ixBindIndexed)(Hooks_UseInitializer.useInitializer(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.localStorage)(Web_HTML.window)))(function (storage) {
                      return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Web_Storage_Storage.getItem(v.key)(storage)))(function (mbItem) {
                          return Data_Maybe.maybe(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Web_Storage_Storage.setItem(v.key)(v.toJson(v.defaultValue))(storage)))(function (item) {
                              return Halogen_Hooks_HookM.modify_(v1.value1)(function (v2) {
                                  return v.fromJson(item);
                              });
                          })(mbItem);
                      });
                  })))(function () {
                      return Halogen_Hooks.discard(Halogen_Hooks_Hook.ixBindIndexed)(useWriteStorage({
                          value: v1.value0,
                          key: v.key
                      }))(function () {
                          return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(new Data_Tuple.Tuple(v1.value0, Halogen_Hooks_HookM.modify_(v1.value1)));
                      });
                  });
              }));
          };
...
(function($PS) {
  ...
  var Hooks_UseLocalStorage = $PS["Hooks.UseLocalStorage"];
  var Simple_JSON = $PS["Simple.JSON"];
  var Web_UIEvent_KeyboardEvent = $PS["Web.UIEvent.KeyboardEvent"];                
  var valuesToDate = function (mvs) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(mvs)(function (v) {
          return Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Date.canonicalDate)(Data_Enum.toEnum(Data_Date_Component.boundedEnumYear)(v.year)))(Data_Enum.toEnum(Data_Date_Component.boundedEnumMonth)(v.month)))(Data_Enum.toEnum(Data_Date_Component.boundedEnumDay)(v.day));
      });
  };
  var twoDigits = function (x) {
      return Data_Int.toNumber(Data_Int.round(x * 100.0)) / 100.0;
  };
  var styleComponent = function (dictMonadAff) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_CSS.stylesheet(CSS_Stylesheet.select(CSS_Elements.body)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundImage(CSS_String.fromString(CSS_Background.isStringBackgroundImage)("linear-gradient(rgba(140,140,140,0.8),rgba(0,0,0,0.8)),url(aagdv_bellac.png)")))(function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Color.white))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundRepeat(CSS_Background.noRepeat))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundSize(CSS_Background.cover))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontFamily([ "Raleway" ])(Data_NonEmpty.singleton(Control_Plus.plusArray)(CSS_Font.sansSerif)))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.label)(CSS_Font.color(Color.black)))(function () {
                                          return CSS_Stylesheet.select(CSS_Elements.sup)(CSS_Font.color(Color.black));
                                      });
                                  });
                              });
                          });
  ...
  var showTwoDigitsInt = function (n) {
      return (function () {
          var $70 = n < 10;
          if ($70) {
              return "0";
          ...
          return "";
      })() + Data_Show.show(Data_Show.showInt)(n);
  };
  var showTwoDigits = function (x) {
      var e = Data_Int.floor(x);
      var d = Data_Int.round((x - Data_Int.toNumber(e)) * 100.0);
      return Data_Show.show(Data_Show.showInt)(e) + ("," + showTwoDigitsInt(d));
  };
  var scriptComponent = function (dictMonadAff) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_Elements.script([ Halogen_HTML_Properties.src("https://kit.fontawesome.com/4958828633.js"), Halogen_HTML_Properties.prop(Halogen_HTML_Core.isPropString)("crossorigin")("anonymous") ])([  ]));
          };
      });
  };
  var safeAt = function (state) {
      return function (period) {
          return function (fluid) {
              return function (n) {
                  var xs = Data_Functor.map(Data_Functor.functorArray)(Data_Lens_Getter.view(fluid(Data_Lens_Internal_Forget.strongForget)))(Data_Lens_Getter.view(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(n)(Data_Lens_Internal_Forget.wanderForget(Data_Monoid.monoidArray)))(Data_Functor.map(Data_Functor.functorArray)(Data_Array.singleton)(Data_Lens_Getter.view(period(Data_Lens_Internal_Forget.strongForget))(state))));
                  return Data_Maybe.fromMaybe(1.0)(Data_Array.index(xs)(0));
              };
          };
      };
  };
  ...
  var prove = function (str) {
      ...
      var $$int = function ($99) {
          return Data_Int.round(Global.readFloat($99));
      };
      ...
      })(Data_Array.index(ns)(0)))(Data_Array.index(ns)(1)))(Data_Array.index(ns)(2));
  };
  var prettyDate = function (mvs) {
      var mdate = valuesToDate(mvs);
      var wday = Data_Maybe.maybe("")(Data_Show.show(Data_Date_Component.showWeekday))(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Date.weekday)(mdate));
      var label = Control_Bind.bind(Data_Maybe.bindMaybe)(mvs)(function (v) {
          return Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(function (w) {
              return function (d) {
                  return function (m) {
                      return function (y) {
                          return w + (" " + (Data_Show.show(Data_Show.showInt)(d) + ("th " + (Data_Show.show(Data_Date_Component.showMonth)(m) + (" " + Data_Show.show(Data_Show.showInt)(y))))));
                      };
                  };
              };
          })(new Data_Maybe.Just(wday)))(new Data_Maybe.Just(v.day)))(Data_Enum.toEnum(Data_Date_Component.boundedEnumMonth)(v.month)))(new Data_Maybe.Just(v.year));
      });
      return Data_Maybe.fromMaybe("")(label);
  };
  var onEnter = function (cb) {
      return Halogen_HTML_Events.onKeyDown(function (ev) {
          var $75 = Web_UIEvent_KeyboardEvent.key(ev) === "Enter";
          if ($75) {
              return cb(Data_Unit.unit);
          };
          return Data_Maybe.Nothing.value;
      });
  };
  var linkComponent = function (dictMonadAff) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_Elements.link([ Halogen_HTML_Properties.rel("stylesheet"), Halogen_HTML_Properties.href("https://fonts.googleapis.com/css?family=Raleway") ]));
          };
      });
  };
  var inputFluid = function (dictMonadEffect) {
      return function (v) {
          return function (period) {
              return function (fluid) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Events.onValueInput(function (strval) {
                      return new Data_Maybe.Just(v.value1(Data_Lens_Setter.over(period(Data_Profunctor_Strong.strongFn))(Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0.emplacement)(Data_Lens_Internal_Wander.wanderFunction))(Data_Lens_Setter.set(fluid(Data_Profunctor_Strong.strongFn))(Global.readFloat(strval))))));
                  }), Halogen_HTML_Events.onFocus(function (v1) {
                      return Data_Maybe.Just.create(v.value1(Data_Lens_Setter.over(period(Data_Profunctor_Strong.strongFn))(Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(0)(Data_Lens_Internal_Wander.wanderFunction))(Data_Lens_Setter.set(fluid(Data_Profunctor_Strong.strongFn))(1.0)))));
                  }), Halogen_HTML_Events.onBlur(function (v1) {
                      return Data_Maybe.Just.create(v.value1(Data_Lens_Setter.over(period(Data_Profunctor_Strong.strongFn))(Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(0)(Data_Lens_Internal_Wander.wanderFunction))(Data_Lens_Setter.set(fluid(Data_Profunctor_Strong.strongFn))(-1.0)))));
                  }) ])((function () {
                      var $79 = safeAt(v.value0)(function (dictStrong) {
                          return period(dictStrong);
                      })(function (dictStrong) {
                          return fluid(dictStrong);
                      })(0) < 0.0;
                      if ($79) {
                          return [ Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(safeAt(v.value0)(function (dictStrong) {
                              return period(dictStrong);
                          })(function (dictStrong) {
                              return fluid(dictStrong);
                          })(v.value0.emplacement))) ];
                      };
                      return [  ];
                  })());
              };
  ...
  var initialState = function (n) {
      return {
          ...
          emplacement: n,
          base: Data_Array.cons({
              eau: -1.0,
              edf: -1.0
          })(Data_Array.replicate(8)(raz)),
          newer: Data_Array.cons({
              eau: -1.0,
              edf: -1.0
          })(Data_Array.replicate(8)(raz)),
          name: "",
  ...
  var empl = function (dictMonadEffect) {
      return function (v) {
          return function (n) {
              return [ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.name("emplacements"), Halogen_HTML_Properties.id_("empl" + Data_Show.show(Data_Show.showInt)(n)), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(n)), Halogen_HTML_Properties.checked(v.value0.emplacement === n), Halogen_HTML_Events.onValueInput(function (newEmpl) {
                  return Data_Maybe.Just.create(v.value1(function (v1) {
                      return {
                          baseDate: v1.baseDate,
                          newerDate: v1.newerDate,
                          emplacement: Data_Int.round(Global.readFloat(newEmpl)),
                          base: v1.base,
                          newer: v1.newer,
                          name: v1.name,
                          notes: v1.notes
  ...
  var dateValuesToValue = function (mvs) {
      return Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
          return Data_Show.show(Data_Show.showInt)(v.year) + ("-" + (showTwoDigitsInt(v.month) + ("-" + showTwoDigitsInt(v.day))));
      })(mvs));
  };
  var addNote = function (state) {
      var $90 = state.name === "";
      if ($90) {
          return state;
      };
      return {
          ...
          newer: state.newer,
          name: "",
          notes: Data_Array.snoc(state.notes)({
              text: state.name
          })
      };
  };
  var _newer = function (dictStrong) {
      return Data_Lens_Lens.lens(function (v) {
          ...
          return function (v1) {
              return {
                  ...
                  name: v.name,
                  newerDate: v.newerDate,
                  notes: v.notes
              };
          };
      })(dictStrong);
  };
  var _edf = function (dictStrong) {
      return Data_Lens_Lens.lens(function (v) {
          return v.edf;
      })(function (v) {
          return function (v1) {
  ...
  var contentComponent = function (dictMonadAff) {
      var composeNote = function (note) {
          var $91 = note === "";
          if ($91) {
              return Halogen_HTML_Elements.p_([  ]);
          };
          return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Press Enter to add: " + note) ]);
      };
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              var defaultValue = initialState(1);
              return Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Hooks_UseLocalStorage.useLocalStorage(dictMonadAff.MonadEffect0())(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "notes";
              }))(Data_Eq.eqArray(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "text";
              }))(Data_Eq.eqString)))))()(new Data_Symbol.IsSymbol(function () {
                  return "newerDate";
              }))(Data_Maybe.eqMaybe(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "year";
                  ...
                  fromJson: function (str) {
                      return Data_Either.either(Data_Function["const"](defaultValue))(Control_Category.identity(Control_Category.categoryFn))(Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "base";
                          ...
                          return "text";
                      }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())))(Simple_JSON.readFieldsNil)()())()())()())()())()())()())()()))(str));
                  },
                  toJson: Simple_JSON.writeJSON(Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
                      return "base";
                  ...
                  key: "intStorageExample"
              }))(function (stateAndModifier) {
                  return Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useState(0))(function (v2) {
                      return Halogen_Hooks.discard(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useLifecycleEffect(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.subscribe(Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
                              return Halogen_Query_EventSource.emit(emitter)(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.get(v2.value1))(function (t) {
                                  return Halogen_Hooks_HookM.put(v2.value1)(t + 1 | 0);
                              }));
                          }))))(function (fiber) {
                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Functor["void"](Effect_Aff.functorAff)(Effect_Aff.killFiber(Effect_Exception.error("Event source finalized"))(fiber)));
                          });
                      })))(function (subId) {
                          return Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(new Data_Maybe.Just(Halogen_Hooks_HookM.unsubscribe(subId)));
                      })))(function () {
                          var consoEdf = twoDigits((safeAt(stateAndModifier.value0)(function (dictStrong) {
                              return _newer(dictStrong);
                          })(function (dictStrong) {
                              return _edf(dictStrong);
                          })(stateAndModifier.value0.emplacement) - safeAt(stateAndModifier.value0)(function (dictStrong) {
                              return _base(dictStrong);
                          })(function (dictStrong) {
                              return _edf(dictStrong);
                          })(stateAndModifier.value0.emplacement)) * _EUROS_PER_kWh_);
                          var consoEau = twoDigits((safeAt(stateAndModifier.value0)(function (dictStrong) {
                              return _newer(dictStrong);
                          })(function (dictStrong) {
                              ...
                              return _eau(dictStrong);
                          })(stateAndModifier.value0.emplacement)) * _EUROS_PER_m3_);
                          var v3 = Data_Maybe.fromMaybe(0.0)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Date.diff(Data_Time_Duration.durationDays))(valuesToDate(stateAndModifier.value0.newerDate)))(valuesToDate(stateAndModifier.value0.baseDate)));
                          var consoEmpl = twoDigits(v3 * _EUROS_PER_DAY_);
                          return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.p([ Halogen_HTML_CSS.style(CSS_Font.fontSize(CSS_Size.em(2.0))) ])([ Halogen_HTML_Core.text("Started " + (Data_Show.show(Data_Show.showInt)(v2.value0) + " seconds ago.")) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(empl(dictMonadAff.MonadEffect0())(stateAndModifier))(Data_Array.range(1)(8))))([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Emplacement " + Data_Show.show(Data_Show.showInt)(stateAndModifier.value0.emplacement)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("far fa-calendar-check") ])([  ]), Halogen_HTML_Core.text(" Check-in : " + prettyDate(stateAndModifier.value0.baseDate)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
                              return CSS_Stylesheet.key(CSS_Property.valString)(CSS_Property.Key(new CSS_Property.Plain("grid-template-columns")))("1fr 1fr 1fr;");
                          })) ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputDate.value), Halogen_HTML_Properties.value(dateValuesToValue(stateAndModifier.value0.baseDate)), Halogen_HTML_Events.onValueInput(function (iAmADate) {
                              return Data_Maybe.Just.create(stateAndModifier.value1(function (v4) {
                                  return {
                                      baseDate: prove(iAmADate),
                                      newerDate: v4.newerDate,
                                      emplacement: v4.emplacement,
                                      base: v4.base,
                                      newer: v4.newer,
                                      name: v4.name,
                                      notes: v4.notes
                          ...
                          }) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fas fa-shower") ])([  ]), Halogen_HTML_Core.text(" Eau : ") ]), Halogen_HTML_Elements.input(inputFluid(dictMonadAff.MonadEffect0())(stateAndModifier)(function (dictStrong) {
                              return _base(dictStrong);
                          })(function (dictStrong) {
                              return _eau(dictStrong);
                          })), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("m") ]), Halogen_HTML_Elements.sup_([ Halogen_HTML_Core.text("3") ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fas fa-charging-station") ])([  ]), Halogen_HTML_Core.text(" Edf : ") ]), Halogen_HTML_Elements.input(inputFluid(dictMonadAff.MonadEffect0())(stateAndModifier)(function (dictStrong) {
                              return _base(dictStrong);
                          })(function (dictStrong) {
                              return _edf(dictStrong);
                          })), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("kWh") ]) ]) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("far fa-calendar") ])([  ]), Halogen_HTML_Core.text(" Check-out : " + prettyDate(stateAndModifier.value0.newerDate)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
                              return CSS_Stylesheet.key(CSS_Property.valString)(CSS_Property.Key(new CSS_Property.Plain("grid-template-columns")))("1fr 1fr 1fr;");
                          })) ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputDate.value), Halogen_HTML_Properties.value(dateValuesToValue(stateAndModifier.value0.newerDate)), Halogen_HTML_Events.onValueInput(function (iAmADate) {
                              return Data_Maybe.Just.create(stateAndModifier.value1(function (v4) {
                                  return {
                                      baseDate: v4.baseDate,
                                      newerDate: prove(iAmADate),
                                      emplacement: v4.emplacement,
                                      base: v4.base,
                                      newer: v4.newer,
                                      name: v4.name,
                              ...
                              return _edf(dictStrong);
                          })), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("kWh") ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
                              return CSS_Stylesheet.key(CSS_Property.valString)(CSS_Property.Key(new CSS_Property.Plain("grid-template-columns")))("1fr 1fr 1fr;");
                          })) ])([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fas fa-bed") ])([  ]), Halogen_HTML_Core.text(" Co\xfbt Emplacement : " + (showTwoDigits(consoEmpl) + " \u20ac")) ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fas fa-shower") ])([  ]), Halogen_HTML_Core.text(" Co\xfbt Eau : " + (showTwoDigits(consoEau) + " \u20ac")) ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fas fa-charging-station") ])([  ]), Halogen_HTML_Core.text(" Co\xfbt Edf : " + (showTwoDigits(consoEdf) + " \u20ac")) ]) ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fas fa-cash-register") ])([  ]), Halogen_HTML_Core.text(" Total : " + (showTwoDigits(consoEau + consoEdf + consoEmpl) + " \u20ac")) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Anything to add?") ]), composeNote(stateAndModifier.value0.name), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.value(stateAndModifier.value0.name), Halogen_HTML_Properties.placeholder("type note"), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Events.onValueInput(function (newName) {
                              return Data_Maybe.Just.create(stateAndModifier.value1(function (v4) {
                                  return {
                                      baseDate: v4.baseDate,
                                      newerDate: v4.newerDate,
                              ...
                              return Data_Maybe.Just.create(stateAndModifier.value1(addNote));
                          }) ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(function (note) {
                              return Halogen_HTML_Elements.li_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(note.text) ]) ]);
                          })(stateAndModifier.value0.notes)), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v4) {
                              return Data_Maybe.Just.create(stateAndModifier.value1(Data_Function["const"](initialState(1))));
                          }) ])([ Halogen_HTML_Core.text("Clear All") ]) ]))));
                      });
                  });
              });
          };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      var drivenBy = function (tag) {
          return function (component) {
              return Control_Bind.bindFlipped(Effect_Aff.bindAff)(Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Halogen_VDom_Driver.runUI(component)(Data_Unit.unit)))(Halogen_Aff_Util.selectElement(tag));
          };
      };
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(drivenBy("head")(linkComponent(Effect_Aff_Class.monadAffAff)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(drivenBy("head")(scriptComponent(Effect_Aff_Class.monadAffAff)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(drivenBy("head")(styleComponent(Effect_Aff_Class.monadAffAff)))(function () {
                  return drivenBy("body")(contentComponent(Effect_Aff_Class.monadAffAff));
              });
          });
      });
  }));
  ...
  exports["showTwoDigitsInt"] = showTwoDigitsInt;
  exports["dateValuesToValue"] = dateValuesToValue;
  exports["prettyDate"] = prettyDate;
  exports["prove"] = prove;
  exports["empl"] = empl;
  exports["safeAt"] = safeAt;
  exports["_base"] = _base;
  exports["_newer"] = _newer;
  exports["_eau"] = _eau;
  exports["_edf"] = _edf;
  ...
  exports["showTwoDigits"] = showTwoDigits;
