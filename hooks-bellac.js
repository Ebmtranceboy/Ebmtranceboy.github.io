...
(function($PS) {
  ...
  var safeAt = function (state) {
      return function (period) {
          return function (fluid) {
              return function (n) {
                  var mx = Data_Array.index(Data_Functor.map(Data_Functor.functorArray)(Data_Lens_Getter.view(fluid(Data_Lens_Internal_Forget.strongForget)))(Data_Lens_Getter.view(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(n)(Data_Lens_Internal_Forget.wanderForget(Data_Monoid.monoidArray)))(Data_Functor.map(Data_Functor.functorArray)(Data_Array.singleton)(Data_Lens_Getter.view(period(Data_Lens_Internal_Forget.strongForget))(state)))))(0);
                  return Data_Maybe.fromMaybe(1.0)(mx);
              };
          };
      };
  };
  ...
  var prove = function (str) {
      ...
      var $$int = function ($91) {
          return Data_Int.round(Global.readFloat($91));
      };
  ...
  var onEnter = function (cb) {
      return Halogen_HTML_Events.onKeyDown(function (ev) {
          var $65 = Web_UIEvent_KeyboardEvent.key(ev) === "Enter";
          if ($65) {
          ...
          return function (period) {
              return function (fluid) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Events.onValueInput(function (strval) {
                      ...
                      var $69 = safeAt(v.value0)(function (dictStrong) {
  ...
  var dateValuesToValue = function (mvs) {
      return Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
          return Data_Show.show(Data_Show.showInt)(v.year) + ("-" + ((function () {
              var $77 = v.month < 10;
              if ($77) {
                  return "0";
              };
              return "";
          })() + (Data_Show.show(Data_Show.showInt)(v.month) + ("-" + ((function () {
              var $78 = v.day < 10;
              if ($78) {
                  return "0";
              };
              return "";
          })() + Data_Show.show(Data_Show.showInt)(v.day))))));
      })(mvs));
  };
  ...
  var aireDeBellac = function (dictMonadAff) {
              ...
              return Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Hooks_UseLocalStorage.useLocalStorage(dictMonadAff.MonadEffect0())(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Halogen_Hooks.bind(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useState(0))(function (v2) {
                      return Halogen_Hooks.discard(Halogen_Hooks_Hook.ixBindIndexed)(Halogen_Hooks.useLifecycleEffect(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.subscribe(Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                          ...
                          var consoEdf = (safeAt(stateAndModifier.value0)(function (dictStrong) {
                          ...
                          var consoEau = (safeAt(stateAndModifier.value0)(function (dictStrong) {
                              return _newer(dictStrong);
                          })(function (dictStrong) {
                          ...
                          var consoEmpl = v3 * _EUROS_PER_DAY_;
                          return Halogen_Hooks.pure(Halogen_Hooks_Hook.ixApplicativeIndexed)(Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Started " + (Data_Show.show(Data_Show.showInt)(v2.value0) + " seconds ago.")) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(empl(dictMonadAff.MonadEffect0())(stateAndModifier))(Data_Array.range(1)(8))))([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Emplacement " + Data_Show.show(Data_Show.showInt)(stateAndModifier.value0.emplacement)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Base : " + prettyDate(stateAndModifier.value0.baseDate)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputDate.value), Halogen_HTML_Properties.value(dateValuesToValue(stateAndModifier.value0.baseDate)), Halogen_HTML_Events.onValueInput(function (iAmADate) {
                          ...
                          }) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Eau : ") ]), Halogen_HTML_Elements.input(inputFluid(dictMonadAff.MonadEffect0())(stateAndModifier)(function (dictStrong) {
                              return _base(dictStrong);
                          })(function (dictStrong) {
                              return _eau(dictStrong);
                          })), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Edf : ") ]), Halogen_HTML_Elements.input(inputFluid(dictMonadAff.MonadEffect0())(stateAndModifier)(function (dictStrong) {
                              return _base(dictStrong);
                          })(function (dictStrong) {
                              return _edf(dictStrong);
                          })), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Newer : " + prettyDate(stateAndModifier.value0.newerDate)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputDate.value), Halogen_HTML_Properties.value(dateValuesToValue(stateAndModifier.value0.newerDate)), Halogen_HTML_Events.onValueInput(function (iAmADate) {
                              return Data_Maybe.Just.create(stateAndModifier.value1(function (v4) {
                                  return {
                              ...
                              return _edf(dictStrong);
                          })), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Conso Eau: " + Data_Show.show(Data_Show.showNumber)(consoEau)) ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Conso Edf: " + Data_Show.show(Data_Show.showNumber)(consoEdf)) ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Co\xfbt Emplacement : " + Data_Show.show(Data_Show.showNumber)(consoEmpl)) ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Total: " + Data_Show.show(Data_Show.showNumber)(consoEau + consoEdf + consoEmpl)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Anything to add?") ]), composeNote(stateAndModifier.value0.name), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.value(stateAndModifier.value0.name), Halogen_HTML_Properties.placeholder("type note"), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Events.onValueInput(function (newName) {
                              return Data_Maybe.Just.create(stateAndModifier.value1(function (v4) {
                                  return {
                                      baseDate: v4.baseDate,
                                      newerDate: v4.newerDate,
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(aireDeBellac(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
  }));
  exports["raz"] = raz;
  ...
  exports["aireDeBellac"] = aireDeBellac;
  exports["main"] = main;
})(PS);
PS["Main"].main();