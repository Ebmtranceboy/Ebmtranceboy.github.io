...
(function($PS) {
  ...
  var isStringBackgroundImage = new CSS_String.IsString((function () {
      var $161 = CSS_String.fromString(CSS_Property.isStringValue);
      return function ($162) {
          return BackgroundImage($161($162));
      };
  })());
...
(function($PS) {
  ...
  var monadAffHookM = function (dictMonadAff) {
      return new Effect_Aff_Class.MonadAff(function () {
          ...
          var $86 = Effect_Aff_Class.liftAff(dictMonadAff);
          return function ($87) {
              return HookM(Control_Monad_Free.liftF(Lift.create($86($87))));
          };
      })());
  };
  ...
  var fork = function (fn) {
      return HookM(Control_Monad_Free.liftF(new Fork(fn, Control_Category.identity(Control_Category.categoryFn))));
  };
  ...
  var monadRecHookM = new Control_Monad_Rec_Class.MonadRec(function () {
      return monadHookM;
  }, function (k) {
      return function (a) {
...
(function($PS) {
  ...
  var useInitializer = function (initializer) {
      return Halogen_Hooks.wrap()(Halogen_Hooks.useLifecycleEffect(Control_Apply.applySecond(Halogen_Hooks_HookM.applyHookM)(initializer)(Control_Applicative.pure(Halogen_Hooks_HookM.applicativeHookM)(Data_Maybe.Nothing.value))));
  };
      ...
      return function (dictEq) {
          return function (v) {
              var hook = (function () {
                  ...
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(v.defaultValue))(function (v1) {
                      return Halogen_Hooks_Hook.discard(Hooks_UseInitializer.useInitializer(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.localStorage)(Web_HTML.window)))(function (storage) {
                          ...
                          return Halogen_Hooks_Hook.discard(useWriteStorage({
                              value: v1.value0,
                              key: v.key
                          }))(function () {
                              return Halogen_Hooks_Hook.pure(new Data_Tuple.Tuple(v1.value0, Halogen_Hooks_HookM.modify_(v1.value1)));
                          });
                      });
                  });
              })();
              return Halogen_Hooks.wrap()(hook);
          };
      };
  };
...
(function($PS) {
  ...
  var unlessEnter = function (defaultCb) {
      return function (cb) {
          return Halogen_HTML_Events.onKeyDown(function (ev) {
              var $72 = Web_UIEvent_KeyboardEvent.key(ev) === "Enter";
              if ($72) {
                  return cb(Data_Unit.unit);
              };
              return defaultCb(Data_Unit.unit);
          });
      };
  };
  ...
  var scriptComponent = function (dictMonadAff) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.script([ Halogen_HTML_Properties.src("https://kit.fontawesome.com/4958828633.js"), Halogen_HTML_Properties.prop(Halogen_HTML_Core.isPropString)("crossorigin")("anonymous") ])([  ]));
          };
      });
  };
  ...
  var prove = function (str) {
      ...
      var $$int = function (s) {
          return Data_Maybe.maybe(0)(Data_Int.round)(Data_Number.fromString(s));
      };
  ...
  var linkComponent = function (dictMonadAff) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.link([ Halogen_HTML_Properties.rel("stylesheet"), Halogen_HTML_Properties.href("https://fonts.googleapis.com/css?family=Raleway") ]));
          };
      });
  };
          ...
          return function (period) {
              return function (fluid) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Events.onValueInput(function (strval) {
                      return v.value1(Data_Lens_Setter.over(period(Data_Profunctor_Strong.strongFn))(Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0.emplacement)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn))(Data_Lens_Setter.set(fluid(Data_Profunctor_Strong.strongFn))((function (s) {
                          return Data_Maybe.fromMaybe(0.0)(Data_Number.fromString(s));
                      })(strval)))));
                  }), Halogen_HTML_Events.onFocus(function (v1) {
                      return v.value1(Data_Lens_Setter.over(period(Data_Profunctor_Strong.strongFn))(Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn))(Data_Lens_Setter.set(fluid(Data_Profunctor_Strong.strongFn))(1.0))));
                  }), Halogen_HTML_Events.onBlur(function (v1) {
                      return v.value1(Data_Lens_Setter.over(period(Data_Profunctor_Strong.strongFn))(Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn))(Data_Lens_Setter.set(fluid(Data_Profunctor_Strong.strongFn))(-1.0))));
                  }) ])((function () {
                      var $81 = safeAt(v.value0)(function (dictStrong) {
  ...
  var empl = function (dictMonadEffect) {
      return function (v) {
          return function (n) {
              return [ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.name("emplacements"), Halogen_HTML_Properties.id("empl" + Data_Show.show(Data_Show.showInt)(n)), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(n)), Halogen_HTML_Properties.checked(v.value0.emplacement === n), Halogen_HTML_Events.onValueInput(function (newEmpl) {
                  return v.value1(function (v1) {
                      return {
                          baseDate: v1.baseDate,
                          newerDate: v1.newerDate,
                          emplacement: Data_Maybe.maybe(0)(Data_Int.round)(Data_Number.fromString(newEmpl)),
                          base: v1.base,
                          newer: v1.newer,
                          name: v1.name,
                          notes: v1.notes
  ...
  var contentComponent = function (dictMonadAff) {
      ...
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              ...
              return Halogen_Hooks_Hook.bind(Hooks_UseLocalStorage.useLocalStorage(dictMonadAff.MonadEffect0())(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "notes";
                  ...
                  return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState(0))(function (v2) {
                      return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(Halogen_Subscription.create))(function (v3) {
                          return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.subscribe(v3.emitter))(function (subId) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Effect_Class.liftEffect(Halogen_Hooks_HookM.monadEffectHookM(dictMonadAff.MonadEffect0()))(Halogen_Subscription.notify(v3.listener)(Data_Functor["void"](Halogen_Hooks_HookM.functorHookM)(Halogen_Hooks_HookM.fork(Control_Monad_Rec_Class.forever(Halogen_Hooks_HookM.monadRecHookM)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)(Data_Functor["void"](Halogen_Hooks_HookM.functorHookM)(Effect_Aff_Class.liftAff(Halogen_Hooks_HookM.monadAffHookM(dictMonadAff))(Effect_Aff.delay(1000.0))))(function () {
                                  return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.get(v2.value1))(function (t) {
                          ...
                          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.p([ Halogen_HTML_CSS.style(CSS_Font.fontSize(CSS_Size.em(2.0))) ])([ Halogen_HTML_Core.text("Started " + (Data_Show.show(Data_Show.showInt)(v2.value0) + " seconds ago.")) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(empl(dictMonadAff.MonadEffect0())(stateAndModifier))(Data_Array.range(1)(8))))([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Emplacement " + Data_Show.show(Data_Show.showInt)(stateAndModifier.value0.emplacement)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("far fa-calendar-check") ])([  ]), Halogen_HTML_Core.text(" Check-in : " + prettyDate(stateAndModifier.value0.baseDate)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.grid))(function () {
                              ...
                              return stateAndModifier.value1(function (v4) {
                                  return {
                          ...
                          }), unlessEnter(function (v4) {
                              return stateAndModifier.value1(Control_Category.identity(Control_Category.categoryFn));
                          })(function (v4) {
                              return stateAndModifier.value1(addNote);
                              ...
                              return stateAndModifier.value1(Data_Function["const"](initialState(1)));
  ...
  exports["unlessEnter"] = unlessEnter;
