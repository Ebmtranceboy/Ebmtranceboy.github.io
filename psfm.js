...
(function($PS) {
  ...
  var path = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return Concur_VDom_DOM["el'"](dictShiftMap)(dictMultiAlternative)(function (p) {
              return function (v) {
                  return Concur_VDom_Types.mkHTMLNode(new Halogen_VDom_Types.Elem(Data_Maybe.Just.create(svgNS), "path", p, [  ]));
              };
          });
      };
  };
...
(function($PS) {
  ...
  var onClick = Concur_VDom_Props.handle("click");
  var onChange = Concur_VDom_Props.handle("input");
  var _type = Concur_VDom_Props.prop("type");
...
(function($PS) {
  ...
  var Data_Sparse_Polynomial = $PS["Data.Sparse.Polynomial"];
  var shiftDimensionRight = function (dictEq) {
      return function (dictSemiring) {
          return function (h) {
              return function (w) {
                  return function (p) {
                      return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (i) {
                          return function (ax) {
                              return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (j) {
                                  return function (ay) {
                                      return Data_Semiring.add(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(Data_Sparse_Polynomial.eqPoly(dictEq)))(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(dictEq))(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring))))(ay)(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(Data_Sparse_Polynomial.query(dictSemiring)(Data_Sparse_Polynomial.query(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring))(p)(j))(i))(0))((h - 1 | 0) - i | 0))(j));
                                  };
                              })(ax)(Data_Array.range(0)(w - 1 | 0));
                          };
                      })(Data_Semiring.zero(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(Data_Sparse_Polynomial.eqPoly(dictEq)))(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(dictEq))(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring)))))(Data_Array.range(0)(h - 1 | 0));
                  };
              };
          };
      };
  };
  var shiftDimensionLeft = function (dictEq) {
      return function (dictSemiring) {
          return function (h) {
              return function (w) {
                  return function (p) {
                      return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (i) {
                          return function (ax) {
                              return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (j) {
                                  return function (ay) {
                                      return Data_Semiring.add(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(Data_Sparse_Polynomial.eqPoly(dictEq)))(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(dictEq))(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring))))(ay)(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(Data_Sparse_Polynomial.query(dictSemiring)(Data_Sparse_Polynomial.query(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring))(p)(j))(i))(i))(j))(0));
                                  };
                              })(ax)(Data_Array.range(0)(w - 1 | 0));
                          };
                      })(Data_Semiring.zero(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(Data_Sparse_Polynomial.eqPoly(dictEq)))(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(dictEq))(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring)))))(Data_Array.range(0)(h - 1 | 0));
                      ...
                      return function (p) {
                          return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (i) {
                              return function (ax) {
                                  return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (j) {
                                      return function (ay) {
                                          return Data_Semiring.add(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(dictEq))(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring)))(ay)(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(Data_Sparse_Polynomial.query(dictSemiring)(Data_Sparse_Polynomial.query(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring))(Data_Sparse_Polynomial.query(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(dictEq))(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring)))(p)(j))(tag))(i))(i))(j));
                                      };
                                  })(ax)(Data_Array.range(0)(w - 1 | 0));
                              };
                          })(Data_Semiring.zero(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(dictEq))(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring))))(Data_Array.range(0)(h - 1 | 0));
                      };
                  };
              };
          };
  ...
  var crazyProduct = function (dictEq) {
      return function (dictSemiring) {
          return function (m1) {
              return function (m2) {
                  return function (tag) {
                      var rw = Data_Sparse_Matrix.width(m2);
                      var nt = Data_Sparse_Matrix.width(m1);
                      var lh = Data_Sparse_Matrix.height(m1);
                      var c2 = shiftDimensionRight(dictEq)(dictSemiring)(nt)(rw)(coefficients(m2));
                      var c1 = shiftDimensionLeft(dictEq)(dictSemiring)(lh)(nt)(coefficients(m1));
                      return {
                          height: lh,
                          width: rw,
                          coefficients: pickTag(dictEq)(dictSemiring)(lh)(rw)(tag)(Data_Semiring.mul(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(Data_Sparse_Polynomial.eqPoly(dictEq)))(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(dictEq))(Data_Sparse_Polynomial.semiringPoly(dictEq)(dictSemiring))))(c1)(c2))
                      };
                  };
              };
          };
  ...
  var b1 = {
      height: 2,
      width: 1,
      coefficients: Data_Semiring.add(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(Data_Eq.eqInt))(Data_Sparse_Polynomial.semiringPoly(Data_Eq.eqInt)(Data_Semiring.semiringInt)))(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(4)(0))(0))(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(6)(1))(0))
  };
  var a1 = {
      height: 2,
      width: 2,
      coefficients: Data_Semiring.add(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(Data_Eq.eqInt))(Data_Sparse_Polynomial.semiringPoly(Data_Eq.eqInt)(Data_Semiring.semiringInt)))(Data_Semiring.add(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(Data_Eq.eqInt))(Data_Sparse_Polynomial.semiringPoly(Data_Eq.eqInt)(Data_Semiring.semiringInt)))(Data_Semiring.add(Data_Sparse_Polynomial.semiringPoly(Data_Sparse_Polynomial.eqPoly(Data_Eq.eqInt))(Data_Sparse_Polynomial.semiringPoly(Data_Eq.eqInt)(Data_Semiring.semiringInt)))(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(2)(0))(0))(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(1)(0))(1)))(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(3)(1))(0)))(Data_Sparse_Matrix.monoPol(Data_Sparse_Matrix.monoPol(5)(1))(1))
  };
  exports["input"] = input;
  exports["a1"] = a1;
  exports["b1"] = b1;
  exports["crazyProduct"] = crazyProduct;
})(PS);
(function($PS) {
  "use strict";
  $PS["Nodes"] = $PS["Nodes"] || {};
  ...
  var label = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return Concur_VDom_DOM.node("label")(dictMultiAlternative)(dictShiftMap);
      };
  };
  var input = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return function (ps) {
              return Concur_VDom_DOM.node("input")(dictMultiAlternative)(dictShiftMap)(ps)([  ]);
          };
      };
  };
  var div$prime = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return Concur_VDom_DOM["node'"]("div")(dictMultiAlternative)(dictShiftMap);
      };
  };
  var button = function (dictMultiAlternative) {
      return function (dictShiftMap) {
          return Concur_VDom_DOM.node("button")(dictMultiAlternative)(dictShiftMap);
      };
  };
...
(function($PS) {
  ...
  var deepRename = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at Main (line 106, column 1 - line 106, column 57): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  ...
  var cell = function (x) {
      return function (y) {
          return function (v) {
              ...
              var fill = charter(v);
              return Concur_VDom_SVG.path(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.stroke("#000000"), Concur_VDom_SVG.strokeWidth(0), Concur_VDom_SVG.fill(fill), Concur_VDom_SVG.d(m(x)(y) + (l(x + 5.0)(y) + (l(x + 5.0)(y + 5.0) + (l(x)(y + 5.0) + "Z")))) ])([  ]);
          };
      };
  };
  ...
  var bar = function (offsetY) {
      return function (x) {
          return function (y) {
              return Concur_VDom_SVG.line(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.unsafeMkProp(Data_Show.showNumber)("x1")(10.0 + 0.5 * x), Concur_VDom_SVG.unsafeMkProp(Data_Show.showNumber)("x2")(10.0 + 0.5 * x), Concur_VDom_SVG.unsafeMkProp(Data_Show.showNumber)("y1")(offsetY), Concur_VDom_SVG.unsafeMkProp(Data_Show.showNumber)("y2")(offsetY - 50.0 * y), Concur_VDom_SVG.stroke("#000000"), Concur_VDom_SVG.strokeWidth(1) ])([  ]);
          };
      };
  };
  ...
  var readWiget = function (st) {
      return Control_Bind.bind(Concur_Core_Types.widgetBind)(Effect_Class.liftEffect(Concur_Core_Types.widgetMonadEff(Data_Monoid.monoidArray))(Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(Web_HTML_HTMLInputElement.files)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_HTML_HTMLInputElement.fromEventTarget)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_Event_Event.target)(st.event)))))(function (mfs) {
          return Control_Bind.bind(Concur_Core_Types.widgetBind)(Effect_Aff_Class.liftAff(Concur_Core_Types.widgetMonadAff(Data_Monoid.monoidArray))(Data_Maybe.maybe(Control_Applicative.pure(Effect_Aff.applicativeAff)(""))(Web_File_FileReader_Aff.readAsText)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function ($61) {
              return Data_Maybe.Just.create(Web_File_File.toBlob($61));
          })(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_File_FileList.item(0))(mfs)))))(function (txt) {
              return Control_Bind.bind(Concur_Core_Types.widgetBind)(Nodes["div'"](Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.input(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Handles["_type"]("file"), Data_Functor.map(Concur_Core_Props.functorProps)(function (ev) {
                  return {
                      event: new Data_Maybe.Just(ev),
                      diff: st.diff,
                      diff2: st.diff2,
                      diff2D: st.diff2D,
                      sig2D: st.sig2D,
              ...
              })(Handles.onChange) ]), Nodes.label(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([  ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(txt) ]), Nodes.button(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Data_Functor.map(Concur_Core_Props.functorProps)(Data_Function["const"]({
                  sig2D: add2D(st.sig2D)(scl2D(epsilon)(Numeric_Calculus.laplacian(st.sig2D))),
                  diff: st.diff,
                  diff2: st.diff2,
                  diff2D: st.diff2D,
                  event: st.event,
                  signal: st.signal
              }))(Handles.onClick) ])([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)("Iterate") ]), Nodes.pre(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Sparse_Matrix.showMatrix(Data_Show.showNumber)(Data_Semiring.semiringNumber)(Data_Eq.eqNumber))(ML_LinAlg.input)) ]), Nodes.pre(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Sparse_Matrix.showMatrix(Data_Show.showInt)(Data_Semiring.semiringInt)(Data_Eq.eqInt))(Data_Semiring.mul(Data_Sparse_Matrix.semiringMatrix(Data_Eq.eqInt)(Data_Semiring.semiringInt))(ML_LinAlg.a1)(ML_LinAlg.b1))) ]), Nodes.pre(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Sparse_Matrix.showMatrix(Data_Show.showInt)(Data_Semiring.semiringInt)(Data_Eq.eqInt))(ML_LinAlg.crazyProduct(Data_Eq.eqInt)(Data_Semiring.semiringInt)(ML_LinAlg.a1)(ML_LinAlg.b1)(0))) ]), Nodes.pre(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Sparse_Matrix.showMatrix(Data_Show.showInt)(Data_Semiring.semiringInt)(Data_Eq.eqInt))(ML_LinAlg.crazyProduct(Data_Eq.eqInt)(Data_Semiring.semiringInt)(ML_LinAlg.a1)(ML_LinAlg.b1)(1))) ]), Nodes.pre(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Nodes.text(Concur_Core_LiftWidget.widgetLiftWidget)(Data_Show.show(Data_Sparse_Matrix.showMatrix(Data_Show.showInt)(Data_Semiring.semiringInt)(Data_Eq.eqInt))(ML_LinAlg.crazyProduct(Data_Eq.eqInt)(Data_Semiring.semiringInt)(ML_LinAlg.a1)(ML_LinAlg.b1)(2))) ]), Concur_VDom_SVG.svg(Concur_Core_Types.widgetMultiAlternative(Data_Monoid.monoidArray))(Concur_Core_Types.widgetShiftMap)([ Concur_VDom_SVG.width("1280"), Concur_VDom_SVG.height("768") ])(plot2D(st.sig2D.samples)) ]))(function (st$prime) {
                  return readWiget(st$prime);
              });
          });
      });
  };
  var main = Concur_VDom_Run.runWidgetInDom("main")(readWiget({
      signal: sigGaussian,
