...
(function($PS) {
  ...
  var system2 = function ($68) {
      return mixer2(f2(source2($68)));
  };
  var f1 = function (arr) {
      return [ -PRNG.nth(arr)(0) | 0, -PRNG.nth(arr)(1) | 0 ];
  };
  var system1 = function ($69) {
      return mixer1(f1(source1($69)));
  };
  ...
  var render = function (s) {
      ...
      return Spork_Html_Elements.div([  ])([ Spork_Html_Elements.label([  ])([ Spork_Html_Core.text(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "min";
      }))(Data_Show.showRecordFieldsNil)(Data_Show.showNumber))(Data_Show.showNumber)))(extremums(s.diff.samples))) ]), Spork_Html_Elements.button([ Spork_Html_Events.onClick(Spork_Html_Events.always_(Iterate.value)) ])([ Spork_Html_Core.text("Iterate") ]), Spork_Html_Elements.input([ Spork_Html_Properties.type_(Spork_Html_Core.inputTypeToPropValue)(DOM_HTML_Indexed_InputType.InputFile.value), Spork_Html_Events.onChange(Spork_Html_Events.always(UpdateFileText.create)) ]), Spork_Html_Elements.label([  ])([ Spork_Html_Core.text(s.textFile) ]), Spork_Html_Core.elemWithNS(ns)("svg")([ Spork_Html_Core.attr("width")("1280"), Spork_Html_Core.attr("height")("768") ])(plot2D(s.sig2D.samples)) ]);
  };
  ...
  var system3 = function ($70) {
      return mixer3(f3(source3($70)));
  };
