...
(function($PS) {
  ...
  var styleComponent = function (v) {
      return Halogen_HTML_CSS.stylesheet(CSS_Stylesheet.select(CSS_Elements.nav)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Elements.a)(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Color.black))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display["float"](CSS_Display.FloatLeft.value))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Data_Maybe.fromMaybe(Color.black)(Color.fromHexString("#f2f2f2"))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_TextAlign.textAlign(CSS_TextAlign.center))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.padding(CSS_Size.px(14.0))(CSS_Size.px(16.0))(CSS_Size.px(14.0))(CSS_Size.px(16.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Text.textDecoration(CSS_Text.noneTextDecoration))(function () {
                              return CSS_Font.fontSize(CSS_Size.px(17.0));
                          });
                      });
                  });
              });
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Stylesheet.select(CSS_Selector["with"](CSS_Elements.a)(CSS_Pseudo.hover))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Data_Maybe.fromMaybe(Color.black)(Color.fromHexString("#ddd"))))(function () {
              return CSS_Font.color(Color.black);
          })))(function () {
              return CSS_Stylesheet.select(CSS_Selector["with"](CSS_Elements.a)(CSS_String.fromString(CSS_Selector.isStringRefinement)(":active")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Data_Maybe.fromMaybe(Color.black)(Color.fromHexString("#4CAF50"))))(function () {
                  return CSS_Font.color(Color.white);
              }));
          });
      })));
  };
  ...
  var onEnter = function (a) {
      return Halogen_HTML_Events.onKeyDown(function (ev) {
          var $14 = Web_UIEvent_KeyboardEvent.key(ev) === "Enter";
          if ($14) {
  ...
  var fromStorage = function __do() {
      var storedModel = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage))((function () {
          var $27 = Data_Functor.map(Effect.functorEffect)(function (v) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(v)((function () {
                  var $30 = Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                      return "notes";
                  ...
                  return function ($31) {
                      return Data_Either.hush($30($31));
                  };
              })());
          });
          var $28 = Web_Storage_Storage.getItem(storageKey);
          return function ($29) {
              return $27($28($29));
          };
      })())();
      ...
      throw new Error("Failed pattern match at Main (line 103, column 10 - line 107, column 10): " + [ storedModel.constructor.name ]);
  };
      ...
      return function (v) {
          ...
          if (v instanceof Tick) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $23.elapsed = state.elapsed + 1 | 0;
                  return $23;
              });
          };
          throw new Error("Failed pattern match at Main (line 118, column 1 - line 120, column 54): " + [ v.constructor.name ]);
      };
  };
  var pageStyle = function (dictMonadAff) {
  ...
  var displayNotes = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.nav_(Data_Array.mapWithIndex(function (i) {
          return function (note) {
              return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#note" + Data_Show.show(Data_Show.showInt)(i)) ])([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(note.text) ]) ]);
          };
      })(state.notes)) ]);
  };
  var composeNote = function (state) {
      var hello = (function () {
          var $26 = state.name === "";
          if ($26) {
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Started " + (Data_Show.show(Data_Show.showInt)(state.elapsed) + " seconds ago.")) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("What is your name?") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.value(state.name), Halogen_HTML_Properties.placeholder("type note"), Halogen_HTML_Properties.autofocus(true), Halogen_HTML_Events.onValueInput(function ($34) {
          return Data_Maybe.Just.create(UpdateName.create($34));
      }), onEnter(AddTodo.value) ]), hello ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ composeNote(state), displayNotes(state), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Data_Function["const"](Data_Maybe.Just.create(new DeleteAll(state.elapsed)))) ])([ Halogen_HTML_Core.text("Clear All") ]) ]);
  };
  var pageRender = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
          initialState: initialState,
          "eval": Halogen_Component.mkEval({
              handleAction: handleAction(dictMonadAff),
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      var drivenBy = function (tag) {
          return function (component) {
              return Control_Bind.bindFlipped(Effect_Aff.bindAff)(Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Halogen_VDom_Driver.runUI(component)(0)))(Halogen_Aff_Util.selectElement(tag));
          };
      };
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(drivenBy("head")(pageStyle(Effect_Aff_Class.monadAffAff)))(function () {
          return drivenBy("body")(pageRender(Effect_Aff_Class.monadAffAff));
      });
  }));
  exports["Initialize"] = Initialize;
  ...
  exports["composeNote"] = composeNote;
