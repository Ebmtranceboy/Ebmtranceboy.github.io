...
(function($PS) {
  ...
  var scalarT = function (v) {
      return Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(((v.ab * v.ab | 0) + (v.ac * v.ac | 0) | 0) - (v.bc * v.bc | 0) | 0))(Data_Rational.fromInt(2));
  };
  ...
  var possibleSides = Data_Array.range(2)(23);
  var randomTriangle = function ($copy_r) {
      var $tco_done = false;
      var $tco_result;
      function $tco_loop(r) {
          var smaller = function (a) {
              return function (b) {
                  return function (c) {
                      return a <= (b + c | 0);
                  };
          ...
          var ok = function (v) {
              return smaller(v.ab)(v.ac)(v.bc) && (smaller(v.ac)(v.bc)(v.ab) && (smaller(v.bc)(v.ab)(v.ac) && (Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)((v.ab + v.ac | 0) + v.bc | 0)(2) === 0 && (((v.ab * v.ab | 0) + (v.ac * v.ac | 0) | 0) !== (v.bc * v.bc | 0) && (((v.ab * v.ab | 0) + (v.bc * v.bc | 0) | 0) !== (v.ac * v.ac | 0) && ((v.ac * v.ac | 0) + (v.bc * v.bc | 0) | 0) !== (v.ab * v.ab | 0))))));
          };
          ...
          var lp = Data_Array.length(possibleSides);
          var indices = Data_Functor.map(Data_Functor.functorArray)(function (x) {
              return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(x)(lp);
          })(Rand.rands(3)(r));
          var sides = Data_Functor.map(Data_Functor.functorArray)(nth(possibleSides))(indices);
          var triangle = {
              ab: nth(sides)(0),
              ac: nth(sides)(1),
              bc: nth(sides)(2)
                  ...
                  return function (equation) {
                      return function (r0) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.section("Exercice 1"))(function () {
                              var h = Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("H"))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" le projet\xe9 orthogonal de "))(function () {
                                      return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("C"))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" sur "))(function () {
                                              return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("(AB)."))(function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("ABC"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" un triangle du plan tel que "))(function () {
                                          var r1 = Rand.rand(r0);
                                          var t1 = randomTriangle(r1);
                                          var s1 = scalarT(t1);
                                          var s2 = scalarT({
                                              ab: t1.ab,
                                              ac: t1.bc,
                                          ...
                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))((function () {
                                              var v = Data_Ord.lessThan(Data_Ratio.ordRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(s2)(Data_Rational.fromInt(0));
                                              var v1 = Data_Ord.lessThan(Data_Ratio.ordRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(s1)(Data_Rational.fromInt(0));
                                              if (v1) {
                                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(" H, A"))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" et "))(function () {
                                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("B"))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" align\xe9s dans cet ordre avec "))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(h)(function () {
                                                                      var ah = Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Ring.negate(Data_Ratio.ringRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(s1))(Data_Rational.fromInt(t1.ab));
                                                                      return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("AH=" + rshow(ah)))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" et "))(function () {
                                                                              return m("AB=" + Data_Show.show(Data_Show.showInt)(t1.ab));
                                                                          });
                                                                      });
                                                                  });
                                                              });
                                              ...
                                              if (!v1 && v) {
                                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("A, B"))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" et "))(function () {
                                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("H"))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" align\xe9s dans cet ordre avec "))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(h)(function () {
                                                                      return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("AB=" + Data_Show.show(Data_Show.showInt)(t1.ab)))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" et "))(function () {
                                                                              var ah = Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(s1)(Data_Rational.fromInt(t1.ab));
                                                                              return m("BH=" + rshow(Data_Ring.sub(Data_Ratio.ringRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(ah)(Data_Rational.fromInt(t1.ab))));
                                                                          });
                                                                      });
                                                                  });
                                                              });
                                              ...
                                              return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("A, H"))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" et "))(function () {
                                                      return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("B"))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" align\xe9s dans cet ordre avec "))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(h)(function () {
                                                                  ...
                                                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("AH=" + rshow(ah)))(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" et "))(function () {
                                                                          return m("HB=" + rshow(Data_Ring.sub(Data_Ratio.ringRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(t1.ab))(ah)));
                                                                      });
                                                                  });
                                                              });
                                                          });
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Calculer "))(function () {
                                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function () {
                                                              var $19 = model.code < 0;
                                                              if ($19) {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                              ...
                                                              return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Data_Monoid.mempty(dictMonoid));
                                                          });
                                                      });
                                                  });
                                              });
...
(function($PS) {
  ...
  var scalarT = function (v) {
      ...
      return (ab.x * ac.x | 0) + (ab.y * ac.y | 0) | 0;
  };
  var possibleValues = Data_Array.range(-13 | 0)(13);
  var randomTriangle = function (r) {
      var nth = function (arr) {
          return function (n) {
              return Data_Maybe.fromJust()(Data_Array.index(arr)(n));
          };
      };
      var lp = Data_Array.length(possibleValues);
      var indices = Data_Functor.map(Data_Functor.functorArray)(function (x) {
          return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(x)(lp);
      })(Rand.rands(6)(r));
      var vals = Data_Functor.map(Data_Functor.functorArray)(nth(possibleValues))(indices);
      return {
          a: {
              x: nth(vals)(0),
              y: nth(vals)(1)
                  ...
                  return function (equation) {
                      return function (r0) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.section("Exercice 2"))(function () {
                              ...
                              var t1 = randomTriangle(r1);
                              var s1 = scalarT(t1);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soient "))(function () {
                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("A(" + (Data_Show.show(Data_Show.showInt)(t1.a.x) + (";" + (Data_Show.show(Data_Show.showInt)(t1.a.y) + ")")))))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(", "))(function () {
                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("B(" + (Data_Show.show(Data_Show.showInt)(t1.b.x) + (";" + (Data_Show.show(Data_Show.showInt)(t1.b.y) + ")")))))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" et "))(function () {
                                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("C(" + (Data_Show.show(Data_Show.showInt)(t1.c.x) + (";" + (Data_Show.show(Data_Show.showInt)(t1.c.y) + ")")))))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" trois points du plan dans un rep\xe8re orthonorm\xe9."))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Calculer "))(function () {
                                                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function () {
                                                                      var $8 = model.code < 0;
                                                                      if ($8) {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("r\xe9ponse: "))(function () {
                                                                                  return m(Data_Show.show(Data_Show.showInt)(s1));
                                                                              });
                                                                          });
                                                                      };
                                                                      return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Data_Monoid.mempty(dictMonoid));
...
(function($PS) {
  ...
  var Rand = $PS["Rand"];
  var SporKaTeX = $PS["SporKaTeX"];                
  var scalarT = function (c) {
      return Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(c * c | 0)(2);
  };
  var possibleValues = Data_Array.range(2)(13);
  var randomTriangle = function (r) {
      var lp = Data_Array.length(possibleValues);
      var index = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)((Rand.rand(r)).val)(lp);
      return 2 * Data_Maybe.fromJust()(Data_Array.index(possibleValues)(index)) | 0;
  };
                  ...
                  return function (equation) {
                      return function (r0) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.section("Exercice 3"))(function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("ABC"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" un triangle \xe9quilat\xe9ral de c\xf4t\xe9 "))(function () {
                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(Data_Show.show(Data_Show.showInt)(t1)))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(". "))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Calculer "))(function () {
                                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function () {
...
(function($PS) {
  ...
  var SporKaTeX = $PS["SporKaTeX"];                
  var scalarT = function (v) {
      return Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(((v.ab * v.ab | 0) + (v.ac * v.ac | 0) | 0) - (v.bc * v.bc | 0) | 0)(2);
  };
  var possibleSides = Data_Array.range(2)(23);
  var randomTriangle = function ($copy_r) {
      var $tco_done = false;
                  ...
                  return function (equation) {
                      return function (r0) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.section("Exercice 4"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("ABC"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" tel que "))(function () {
                                          var r1 = Rand.rand(r0);
                                          var t1 = randomTriangle(r1);
                                          var s1 = scalarT(t1);
                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("AB = " + Data_Show.show(Data_Show.showInt)(t1.ab)))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(", "))(function () {
                                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("AC = " + Data_Show.show(Data_Show.showInt)(t1.ac)))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" et "))(function () {
                                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("BC = " + Data_Show.show(Data_Show.showInt)(t1.bc)))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Calculer "))(function () {
                                                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\overrightarrow{AB}\\cdot\\overrightarrow{AC}."))(function () {
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Exercise5"] = $PS["Exercise5"] || {};
  var exports = $PS["Exercise5"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Trans = $PS["Control.Monad.State.Trans"];
  var Data_Array = $PS["Data.Array"];
  ...
  var randomTriangle = function (r) {
      ...
      var lp = Data_Array.length(possibleValues);
      return {
          ab: nth(possibleValues)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r1.val)(lp)),
          ac: nth(possibleValues)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r2.val)(lp)),
          t: Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r.val)(2) === 0
      };
  };
  var exo5 = function (dictDiscard) {
      return function (dictMonoid) {
          return function (model) {
              return function (m) {
                  return function (equation) {
                      return function (r0) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.section("Exercice 5"))(function () {
                              var r1 = Rand.rand(r0);
                              var t1 = randomTriangle(r1);
                              var s1 = scalarT(t1);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("ABC"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" un triangle tel que "))(function () {
                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("AB = " + Data_Show.show(Data_Show.showInt)(t1.ab)))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(", "))(function () {
                                                  return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("AC = " + Data_Show.show(Data_Show.showInt)(2 * t1.ac | 0)))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" et "))(function () {
                                                          return Control_Bind.discard(dictDiscard)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\widehat{BAC}=" + (function () {
                                                              if (t1.t) {
                                                                  return "\\frac{\\pi}{3}";
                                                              };
                                                              return "\\frac{2\\pi}{3}";
...
(function($PS) {
      ...
      return function (v) {
          ...
          if (v instanceof RenderElement) {
              var effects = (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 74, column 17 - line 76, column 30): " + [ v.value1.constructor.name ]);
              })();
              return {
                  model: model,
                  effects: effects
          ...
          throw new Error("Failed pattern match at Main (line 52, column 16 - line 78, column 25): " + [ v.constructor.name ]);
      };
  };
  ...
  var lines = function (model) {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Exercise1.exo1(Control_Bind.discardUnit)(Data_Monoid.monoidUnit)(model)(m)(equation)(Data_Maybe.fromJust()(Data_Array.index(model.seeds)(0))))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Exercise2.exo2(Control_Bind.discardUnit)(Data_Monoid.monoidUnit)(model)(m)(equation)(Data_Maybe.fromJust()(Data_Array.index(model.seeds)(1))))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Exercise3.exo3(Control_Bind.discardUnit)(Data_Monoid.monoidUnit)(model)(m)(equation)(Data_Maybe.fromJust()(Data_Array.index(model.seeds)(2))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Exercise4.exo4(Control_Bind.discardUnit)(Data_Monoid.monoidUnit)(model)(m)(equation)(Data_Maybe.fromJust()(Data_Array.index(model.seeds)(3))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Exercise5.exo5(Control_Bind.discardUnit)(Data_Monoid.monoidUnit)(model)(m)(equation)(Data_Maybe.fromJust()(Data_Array.index(model.seeds)(4))))(function () {
  ...
  var header = Spork_Html_Elements.div([  ])(SporKaTeX.fromIncremental((function () {
      var m = SporKaTeX.mathInline(RenderElement.create);
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.setTitle("Devoir 6 : Produit scalaire"))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Pr\xe9nom:"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(spacex(40)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Classe:"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(Spork_Html_Elements.ul([  ])([ Spork_Html_Elements.li([  ])([ Spork_Html_Core.text("5 produits scalaires \xe0 calculer") ]), Spork_Html_Elements.li([  ])([ Spork_Html_Core.text("1 point par bonne r\xe9ponse") ]), Spork_Html_Elements.li([  ])([ Spork_Html_Core.text("calculatrice autoris\xe9e") ]), Spork_Html_Elements.li([  ])([ Spork_Html_Core.text("documents autoris\xe9s") ]) ])))(function () {
                                      return SporKaTeX.get(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity));
                                  });
                              });
                          });
