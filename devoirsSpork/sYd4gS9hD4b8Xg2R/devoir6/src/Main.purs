...
header = H.div [] $  KaTeX.fromIncremental $ do
  ...
  setTitle "Devoir 6 : Produit scalaire"
  t "Nom:"
  m $ spacex 40
  t "Prénom:"
  m $ spacex 40
  ...
  KaTeX.put $ H.ul []
      [ H.li [] [H.text "5 produits scalaires à calculer"]
      , H.li [] [H.text "1 point par bonne réponse"]
...
lines model = do
  ...
  exo5 model m equation $ unsafePartial $ fromJust $ model.seeds !! 4
  KaTeX.get
