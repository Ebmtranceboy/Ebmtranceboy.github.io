...
(function($PS) {
      ...
      return function (v) {
          ...
          if (v instanceof RenderElement) {
              var effects = (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 56, column 17 - line 58, column 30): " + [ v.value1.constructor.name ]);
              })();
              return {
                  model: model,
                  effects: effects
          ...
          throw new Error("Failed pattern match at Main (line 42, column 16 - line 60, column 25): " + [ v.constructor.name ]);
      };
  };
  ...
  var showInline = function (n) {
      return function (suffix) {
          ...
          throw new Error("Failed pattern match at Main (line 139, column 3 - line 146, column 62): " + [ Data_Unit.unit.constructor.name ]);
      };
  };
  var showHead = function (n) {
      return function (suffix) {
          return (function () {
              ...
              throw new Error("Failed pattern match at Main (line 131, column 6 - line 134, column 33): " + [ Data_Unit.unit.constructor.name ]);
          })() + suffix;
      };
  };
  var showFraction = function (r) {
      var $19 = Data_Ratio.denominator(r) === 1;
      if ($19) {
          return Data_Show.show(Data_Show.showInt)(Data_Ratio.numerator(r));
      };
      return "\\frac{" + (Data_Show.show(Data_Show.showInt)(Data_Ratio.numerator(r)) + ("}{" + (Data_Show.show(Data_Show.showInt)(Data_Ratio.denominator(r)) + "}")));
  };
  ...
  var randPositive = function ($copy_r) {
      ...
      var $tco_result;
      function $tco_loop(r) {
          var $31 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r.val)(intMax) === 0;
          if ($31) {
              $copy_r = Rand.rand(r);
              return;
          };
  ...
  var randAffine = function (r) {
      ...
      var rp = Rand.rand(rm);
      var rsp = Rand.rand(rp);
      var sp = (function () {
          var $32 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rsp.val)(2) === 0;
          if ($32) {
              return 1;
          };
          return -1 | 0;
      ...
      return {
          m: Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rm.val)(intMax),
          p: sp * Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rp.val)(intMax) | 0,
          r: rsp
      };
  };
  var lines = function (model) {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
              var rk1 = randPositive(r0);
              var k1 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rk1.val)(intMax);
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.b("1. "))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("(v_n)_{n\\in\\mathbb{N}}"))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" une suite d\xe9finie par son premier terme et la relation "))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("v_{n+1}=\\left(" + (Data_Show.show(Data_Show.showInt)(k1) + ("+\\dfrac{v_n}{" + (Data_Show.show(Data_Show.showInt)(2 * k1 | 0) + ("}\\right)^2-\\dfrac{v_n^2}{" + (Data_Show.show(Data_Show.showInt)((4 * k1 | 0) * k1 | 0) + "}")))))))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(". "))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("(v_n)"))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" est une suite :"))(function () {
                                                  var rs1 = Rand.rand(Rand.rand(Rand.rand(rk1)));
                                                  var rep1 = [ 1 ];
                                                  var prop1 = [ "\\mathrm{g\xe9om\xe9trique}\\;\\mathrm{de}\\;\\mathrm{raison}\\;" + Data_Show.show(Data_Show.showInt)(k1), "\\mathrm{arithm\xe9tique}\\;\\mathrm{de}\\;\\mathrm{raison}\\;" + Data_Show.show(Data_Show.showInt)(k1 * k1 | 0), "\\mathrm{ni}\\;\\mathrm{arithm\xe9tique}\\;\\mathrm{ni}\\;\\mathrm{g\xe9om\xe9trique}\\;" ];
                                                  var ord1 = Rand.unsort(3)(rk1);
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(m)(prop1)(ord1)))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                      ...
                                                                      var k2 = (2 * Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rk2.val)(intMax) | 0) + 1 | 0;
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.b("2. "))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("(u_n)_{n\\in\\mathbb{N}}"))(function () {
                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" une suite d\xe9finie par son premier terme et la relation "))(function () {
                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("u_{n+1}=\\left(\\dfrac{" + (Data_Show.show(Data_Show.showInt)(k2) + ("}{2}+u_n\\right)^2-\\left(\\dfrac{" + (Data_Show.show(Data_Show.showInt)(k2 * k2 | 0) + "}{4}+u_n^2 \\right)")))))(function () {
                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(". "))(function () {
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("(u_n)"))(function () {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" est une suite :"))(function () {
                                                                                                          var rs2 = Rand.rand(Rand.rand(Rand.rand(rk2)));
                                                                                                          var rep2 = [ 0 ];
                                                                                                          var prop2 = [ "\\mathrm{g\xe9om\xe9trique}\\;\\mathrm{de}\\;\\mathrm{raison}\\;" + Data_Show.show(Data_Show.showInt)(k2), "\\mathrm{arithm\xe9tique}\\;\\mathrm{de}\\;\\mathrm{raison}\\;\\dfrac{" + (Data_Show.show(Data_Show.showInt)(k2) + "}{2}"), "\\mathrm{ni}\\;\\mathrm{arithm\xe9tique}\\;\\mathrm{ni}\\;\\mathrm{g\xe9om\xe9trique}\\;" ];
                                                                                                          var ord2 = Rand.unsort(3)(rk2);
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(m)(prop2)(ord2)))(function () {
                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                              ...
                                                                                                                              var u3 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(ru3.val)(intMax);
                                                                                                                              var rr3 = randPositive(Rand.rand(ru3));
                                                                                                                              var rn3 = randPositive(Rand.rand(rr3));
                                                                                                                              var r3 = 1 + Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rr3.val)(intMax) | 0;
                                                                                                                              var n3 = 15 + Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rn3.val)(intMax) | 0;
                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.b("3. "))(function () {
                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("La somme "))(function () {
                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(Data_Show.show(Data_Show.showInt)(u3) + ("+" + (Data_Show.show(Data_Show.showInt)(u3 + r3 | 0) + ("+" + (Data_Show.show(Data_Show.showInt)(u3 + (2 * r3 | 0) | 0) + ("+\\cdots +" + Data_Show.show(Data_Show.showInt)(u3 + (n3 * r3 | 0) | 0))))))))(function () {
                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" est \xe9gale \xe0 :"))(function () {
                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                  var rs3 = Rand.rand(Rand.rand(Rand.rand(rn3)));
                                                                                                                                                  var rep3 = [ 0, 2 ];
                                                                                                                                                  var prop3 = [ Data_Show.show(Data_Show.showInt)(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)((n3 + 1 | 0) * ((u3 + u3 | 0) + (n3 * r3 | 0) | 0) | 0)(2)), Data_Show.show(Data_Show.showInt)(u3) + ("\\times\\dfrac{1-" + (Data_Show.show(Data_Show.showInt)(r3) + ("^{" + (Data_Show.show(Data_Show.showInt)(n3 + 1 | 0) + ("}}{1-" + (Data_Show.show(Data_Show.showInt)(r3) + "}")))))), Data_Show.show(Data_Show.showInt)(n3 + 1 | 0) + ("\\times\\dfrac{" + (Data_Show.show(Data_Show.showInt)(u3) + ("+" + (Data_Show.show(Data_Show.showInt)(u3 + (n3 * r3 | 0) | 0) + "}{2}")))) ];
                                                                                                                                                  var ord3 = Rand.unsort(3)(rn3);
                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                              ...
                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                      var qpos = function ($copy_r) {
                                                                                                                                                                          ...
                                                                                                                                                                          var $tco_result;
                                                                                                                                                                          function $tco_loop(r) {
                                                                                                                                                                              var $33 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r.val)(5) === 0;
                                                                                                                                                                              if ($33) {
                                                                                                                                                                                  $copy_r = Rand.rand(r);
                                                                                                                                                                                  return;
                                                                                                                                                                              };
                                                                                                                                                                      ...
                                                                                                                                                                      var rq4 = qpos(Rand.rand(rs3));
                                                                                                                                                                      var rn4 = randPositive(Rand.rand(rq4));
                                                                                                                                                                      var q4 = 1 + Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rq4.val)(5) | 0;
                                                                                                                                                                      var qs = function (v) {
                                                                                                                                                                          if (v === 1) {
                                                                                                                                                                              return q4;
                                                                                                                                                                          };
                                                                                                                                                                          return q4 * qs(v - 1 | 0) | 0;
                                                                                                                                                                      };
                                                                                                                                                                      var n4 = 5 + Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rn4.val)(5) | 0;
                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.b("4. "))(function () {
                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("La somme "))(function () {
                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(Data_Show.show(Data_Show.showInt)(1) + ("+" + (Data_Show.show(Data_Show.showInt)(q4) + ("+" + (Data_Show.show(Data_Show.showInt)(q4 * q4 | 0) + ("+\\cdots +" + Data_Show.show(Data_Show.showInt)(qs(n4)))))))))(function () {
                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" est \xe9gale \xe0 :"))(function () {
                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                          var rs4 = Rand.rand(Rand.rand(Rand.rand(rn4)));
                                                                                                                                                                                          var rep4 = [ 0, 1 ];
                                                                                                                                                                                          var prop4 = [ Data_Show.show(Data_Show.showInt)(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(1 - qs(n4 + 1 | 0) | 0)(1 - q4 | 0)), "\\dfrac{1-" + (Data_Show.show(Data_Show.showInt)(q4) + ("^{" + (Data_Show.show(Data_Show.showInt)(n4 + 1 | 0) + ("}}{1-" + (Data_Show.show(Data_Show.showInt)(q4) + "}"))))), Data_Show.show(Data_Show.showInt)(n4 + 1 | 0) + ("\\times\\dfrac{" + (Data_Show.show(Data_Show.showInt)(1) + ("+" + (Data_Show.show(Data_Show.showInt)(qs(n4)) + "}{2}")))) ];
                                                                                                                                                                                          var ord4 = Rand.unsort(3)(rn4);
                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.b("5. "))(function () {
                                                                                                                                                                                                                  var rden5 = randPositive(Rand.rand(rs4));
                                                                                                                                                                                                                  var den5 = 1 + Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rden5.val)(intMax) | 0;
                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\lim\\limits_{n\\rightarrow + \\infty} \\left(\\dfrac{1}{" + (Data_Show.show(Data_Show.showInt)(den5) + "}\\right)^n=")))(function () {
                                                                                                                                                                                                                      var rs5 = Rand.rand(Rand.rand(Rand.rand(rden5)));
                                                                                                                                                                                                                      var rep5 = [ 0 ];
                                                                                                                                                                                                                      var prop5 = [ "0", "+\\infty", "\\dfrac{1}{" + (Data_Show.show(Data_Show.showInt)(den5) + "}") ];
                                                                                                                                                                                                                      var ord5 = Rand.unsort(3)(rden5);
                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.b("6. "))(function () {
                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("f"))(function () {
                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" la fonction d\xe9finie sur "))(function () {
                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(" ]" + (showFraction(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(-v.p | 0))(Data_Rational.fromInt(m6))) + "; + \\infty[")))(function () {
                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" par "))(function () {
                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(" f(x)=\\sqrt{" + (showAffine({
                                                                                                                                                                                                                                                                      m: m6,
                                                                                                                                                                                                                                                                      p: v.p
                                                                                                                                                                                                                                                                  }) + "}")))(function () {
                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Alors "))(function () {
                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("f'(x)="))(function () {
                                                                                                                                                                                                                                                                                      var rs6 = Rand.rand(Rand.rand(Rand.rand(v.r)));
                                                                                                                                                                                                                                                                                      var rep6 = [ 0 ];
                                                                                                                                                                                                                                                                                      var prop6 = [ "\\dfrac{" + (Data_Show.show(Data_Show.showInt)(m6) + ("}{2\\sqrt{" + (showAffine({
                                                                                                                                                                                                                                                                                          m: m6,
                                                                                                                                                                                                                                                                                          p: v.p
                                                                                                                                                                                                                                                                                      }) + "}}"))), "\\sqrt{" + (Data_Show.show(Data_Show.showInt)(m6) + "}"), "\\dfrac{1}{" + (showAffine({
                                                                                                                                                                                                                                                                                          m: m6,
                                                                                                                                                                                                                                                                                          p: v.p
                                                                                                                                                                                                                                                                                      }) + "}") ];
                                                                                                                                                                                                                                                                                      var ord6 = Rand.unsort(3)(v.r);
                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.b("7. "))(function () {
                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("f"))(function () {
                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" la fonction d\xe9finie sur "))(function () {
                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(" ]" + (showFraction(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(-v1.p | 0))(Data_Rational.fromInt(m7))) + "; + \\infty[")))(function () {
                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" par "))(function () {
                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(" f(x)=\\dfrac{1}{" + (showAffine({
                                                                                                                                                                                                                                                                                                                                      m: m7,
                                                                                                                                                                                                                                                                                                                                      p: v1.p
                                                                                                                                                                                                                                                                                                                                  }) + "}")))(function () {
                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Alors "))(function () {
                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("f'(x)="))(function () {
                                                                                                                                                                                                                                                                                                                                                      var rs7 = Rand.rand(Rand.rand(Rand.rand(v1.r)));
                                                                                                                                                                                                                                                                                                                                                      var rep7 = [ 0 ];
                                                                                                                                                                                                                                                                                                                                                      var prop7 = [ "\\dfrac{" + (Data_Show.show(Data_Show.showInt)(-m7 | 0) + ("}{\\left(" + (showAffine({
                                                                                                                                                                                                                                                                                                                                                          m: m7,
                                                                                                                                                                                                                                                                                                                                                          p: v1.p
                                                                                                                                                                                                                                                                                                                                                      }) + "\\right)^2}"))), "\\dfrac{1}{\\left(" + (showAffine({
                                                                                                                                                                                                                                                                                                                                                          m: m7,
                                                                                                                                                                                                                                                                                                                                                          p: v1.p
                                                                                                                                                                                                                                                                                                                                                      }) + "\\right)^2}"), "\\dfrac{1}{" + (Data_Show.show(Data_Show.showInt)(m7) + "}") ];
                                                                                                                                                                                                                                                                                                                                                      var ord7 = Rand.unsort(3)(v1.r);
                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("f"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" la fonction d\xe9finie sur "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\mathbb{R}"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" par "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(" f(x)=\\left(" + (showAffine({
                                                                                                                                                                                                                                                                                                                                                                                                      m: m8,
                                                                                                                                                                                                                                                                                                                                                                                                      p: v2.p
                                                                                                                                                                                                                                                                                                                                                                                                  }) + "\\right)^3")))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Alors "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("f'(x)="))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                      var rep8 = [ 0 ];
                                                                                                                                                                                                                                                                                                                                                                                                                      var prop8 = [ Data_Show.show(Data_Show.showInt)(3 * m8 | 0) + ("\\left(" + (showAffine({
                                                                                                                                                                                                                                                                                                                                                                                                                          m: m8,
                                                                                                                                                                                                                                                                                                                                                                                                                          p: v2.p
                                                                                                                                                                                                                                                                                                                                                                                                                      }) + "\\right)^2")), "3\\left(" + (showAffine({
                                                                                                                                                                                                                                                                                                                                                                                                                          m: m8,
                                                                                                                                                                                                                                                                                                                                                                                                                          p: v2.p
                                                                                                                                                                                                                                                                                                                                                                                                                      }) + "\\right)^2"), Data_Show.show(Data_Show.showInt)((m8 * m8 | 0) * m8 | 0) ];
                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.put(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity))(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(showProp(m)(prop8)(ord8)))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                          var ra9 = randPositive(Rand.rand(rs8));
                                                                                                                                                                                                                                                                                                                                                                                                                                          var rb9 = randPositive(Rand.rand(ra9));
                                                                                                                                                                                                                                                                                                                                                                                                                                          var b9 = (2 * Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(rb9.val)(intMax) | 0) + 1 | 0;
                                                                                                                                                                                                                                                                                                                                                                                                                                          var a9 = 2 * Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(ra9.val)(intMax) | 0;
                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("f"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" la fonction d\xe9finie sur "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\mathbb{R}"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" par "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(" f(x)=(x-" + (Data_Show.show(Data_Show.showInt)(a9) + (")(x-" + (Data_Show.show(Data_Show.showInt)(b9) + ")")))))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Alors "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("f'(x)="))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      var rs9 = Rand.rand(Rand.rand(Rand.rand(rb9)));
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      var rep9 = [ 0 ];
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      var prop9 = [ showAffine({
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          m: 2,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          p: -(a9 + b9 | 0) | 0
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      }), "1", Data_Show.show(Data_Show.showInt)(a9 + b9 | 0) ];
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      var ord9 = Rand.unsort(3)(rb9);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" la fonction d\xe9finie sur "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\mathbb{R}"))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" par "))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m(" f(x)=(x-" + (Data_Show.show(Data_Show.showInt)(a9) + (")(x-" + (Data_Show.show(Data_Show.showInt)(b9) + ")")))))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          var rs10 = Rand.rand(Rand.rand(Rand.rand(rs9)));
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          var rep10 = [ 0, 1 ];
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          var prop10 = [ "f'(" + (showFraction(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(a9 + b9 | 0))(Data_Rational.fromInt(2))) + ")=0"), "f'(" + (Data_Show.show(Data_Show.showInt)(a9 + b9 | 0) + (")=" + Data_Show.show(Data_Show.showInt)(a9 + b9 | 0))), "f'(" + (showFraction(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(a9 + b9 | 0))(Data_Rational.fromInt(2))) + (")=" + showFraction(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(a9 + b9 | 0))(Data_Rational.fromInt(2))))) ];
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          var ord10 = Rand.unsort(3)(rs9);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
  ...
  var header = Spork_Html_Elements.div([  ])(SporKaTeX.fromIncremental((function () {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.setTitle("Devoir 10 : Suites arithm\xe9tiques / Suites g\xe9om\xe9triques / Fonctions d\xe9riv\xe9es"))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
