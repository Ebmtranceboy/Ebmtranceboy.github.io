...
(function($PS) {
      ...
      return function (b) {
          return function (c) {
              var m2 = (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 66, column 9 - line 69, column 49): " + [ Data_Unit.unit.constructor.name ]);
              })();
              var m1 = (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 71, column 9 - line 76, column 54): " + [ Data_Unit.unit.constructor.name ]);
              })();
  ...
  var symx = function (a) {
      ...
      throw new Error("Failed pattern match at Main (line 102, column 3 - line 115, column 26): " + [ Data_Unit.unit.constructor.name ]);
  };
  var symy = function (a) {
      if (a === m5pi_6) {
          return mpi_6;
      ...
      throw new Error("Failed pattern match at Main (line 120, column 3 - line 133, column 26): " + [ Data_Unit.unit.constructor.name ]);
  };
  ...
  var positive = function (a) {
      ...
      throw new Error("Failed pattern match at Main (line 145, column 3 - line 152, column 26): " + [ Data_Unit.unit.constructor.name ]);
  };
  var sixths = [ {
      exact: "\\frac{-13\\pi}{6}",
  ...
  var randFraction = function (r) {
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          throw new Error("Failed pattern match at Main (line 37, column 7 - line 37, column 28): " + [ v1.constructor.name ]);
      };
      throw new Error("Failed pattern match at Main (line 34, column 7 - line 34, column 28): " + [ v.constructor.name ]);
  };
  var cb = function (doc) {
      return function (ev) {
          return function __do() {
              ...
              var v3 = DOM_Editor.setAttribute("style")("display: grid; grid-template-columns : 2fr 4fr;")(v2)();
              var v4 = DOM_Editor.createElement("div")(doc)();
              var v5 = DOM_Editor.newSVG("position: relative; width: 400; height: 310;")(v2)();
              var ctx = (function () {
                  var v6 = SVG_Render.defaultContext(v5);
                  return {
                      strokeWidth: 1.0,
                      fill: v6.fill,
                      fontStyle: v6.fontStyle,
                      stroke: v6.stroke,
                      svg: v6.svg,
                      textFill: v6.textFill
                  };
              })();
              var v6 = DOM_Editor.appendChild(v4)(v2)();
              var v7 = DOM_Editor.appendChild(v2)(v1)();
              var draw1 = function (dictRender) {
                  return SVG_Render["render'"](dictRender)(ctx);
              };
              var pO = SVG_Geometry.point("O")(150.0)(90.0);
              var pA = SVG_Geometry.point("A")(150.0 - 2.0 * 55.0)(90.0 + 55.0);
              var pB = SVG_Geometry.point("B")(150.0 + 2.0 * 55.0)(90.0 + 55.0);
              var pC = SVG_Geometry.point("C")(150.0 + 2.0 * 55.0)(90.0 - 55.0);
              var pD = SVG_Geometry.point("D")(150.0 - 2.0 * 55.0)(90.0 - 55.0);
              var pE = SVG_Geometry.point("")((150.0 - 2.0 * 55.0) + 25.0)((90.0 + 55.0) - 25.0);
              var pF = SVG_Geometry.point("")((150.0 + 2.0 * 55.0) - 25.0)((90.0 + 55.0) - 25.0);
              var pG = SVG_Geometry.point("")((150.0 + 2.0 * 55.0) - 25.0)((90.0 - 55.0) + 25.0);
              var pH = SVG_Geometry.point("")((150.0 - 2.0 * 55.0) + 25.0)((90.0 - 55.0) + 25.0);
              draw1(SVG_Render.renderSequence(SVG_Render.renderPoint))([ pO, pA, pB, pC, pD ])();
              draw1(SVG_Render.renderSequence(SVG_Render.renderSegment))([ SVG_Geometry.segment(pA)(pB)(Data_Maybe.Nothing.value), SVG_Geometry.segment(pB)(pC)(Data_Maybe.Nothing.value), SVG_Geometry.segment(pC)(pD)(Data_Maybe.Nothing.value), SVG_Geometry.segment(pD)(pA)(Data_Maybe.Nothing.value) ])();
              draw1(SVG_Render.renderSequence(SVG_Render.renderSegment))([ SVG_Geometry.segment(pE)(pF)(Data_Maybe.Nothing.value), SVG_Geometry.segment(pF)(pG)(Data_Maybe.Nothing.value), SVG_Geometry.segment(pG)(pH)(Data_Maybe.Nothing.value), SVG_Geometry.segment(pH)(pE)(Data_Maybe.Nothing.value) ])();
              var pI = SVG_Geometry.middle("")(SVG_Geometry.segment(pA)(pD)(Data_Maybe.Nothing.value));
              var v8 = SVG_Geometry.meets(SVG_Geometry.interLineLine)(SVG_Geometry.line(pO)(pI))(SVG_Geometry.line(pE)(pH));
              if (v8.length === 1) {
                  draw1(SVG_Render.renderSequence(SVG_Render.renderPoint))([ SVG_Geometry.rename("\ud835\udc65")(pI), v8[0] ])();
                  draw1(SVG_Render.renderSegment)(SVG_Geometry.segment(pI)(v8[0])(Data_Maybe.Nothing.value))();
                  var pJ = SVG_Geometry.middle("")(SVG_Geometry.segment(pB)(pC)(Data_Maybe.Nothing.value));
                  var v9 = SVG_Geometry.meets(SVG_Geometry.interLineLine)(SVG_Geometry.line(pO)(pJ))(SVG_Geometry.line(pF)(pG));
                  if (v9.length === 1) {
                      draw1(SVG_Render.renderSequence(SVG_Render.renderPoint))([ SVG_Geometry.rename("\ud835\udc65")(v9[0]), pJ ])();
                      draw1(SVG_Render.renderSegment)(SVG_Geometry.segment(pJ)(v9[0])(Data_Maybe.Nothing.value))();
                      var pM = SVG_Geometry.middle("")(SVG_Geometry.segment(pA)(pB)(Data_Maybe.Nothing.value));
                      var v10 = SVG_Geometry.meets(SVG_Geometry.interLineLine)(SVG_Geometry.line(pO)(pM))(SVG_Geometry.line(pE)(pF));
                      if (v10.length === 1) {
                          draw1(SVG_Render.renderSequence(SVG_Render.renderPoint))([ SVG_Geometry.rename("\ud835\udc65")(pM), v10[0] ])();
                          draw1(SVG_Render.renderSegment)(SVG_Geometry.segment(pM)(v10[0])(Data_Maybe.Nothing.value))();
                          var pP = SVG_Geometry.middle("")(SVG_Geometry.segment(pC)(pD)(Data_Maybe.Nothing.value));
                          var v11 = SVG_Geometry.meets(SVG_Geometry.interLineLine)(SVG_Geometry.line(pO)(pP))(SVG_Geometry.line(pG)(pH));
                          if (v11.length === 1) {
                              draw1(SVG_Render.renderSequence(SVG_Render.renderPoint))([ SVG_Geometry.rename("\ud835\udc65")(v11[0]), pP ])();
                              draw1(SVG_Render.renderSegment)(SVG_Geometry.segment(v11[0])(pP)(Data_Maybe.Nothing.value))();
                              KaTeX.raw("On donne ")();
                              var r1 = Rand.rand(r0);
                          ...
                          throw new Error("Failed pattern match at Main (line 307, column 7 - line 307, column 47): " + [ v11.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main (line 302, column 7 - line 302, column 47): " + [ v10.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main (line 297, column 7 - line 297, column 47): " + [ v9.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 292, column 7 - line 292, column 47): " + [ v8.constructor.name ]);
          };
      };
  };
