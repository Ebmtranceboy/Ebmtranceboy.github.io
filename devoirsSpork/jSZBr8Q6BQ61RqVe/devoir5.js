...
(function($PS) {
  ...
  exports["bold"] = $foreign.bold;
  exports["cat"] = $foreign.cat;
  exports["emph"] = $foreign.emph;
...
(function($PS) {
  ...
  var tree = function (doc) {
      return function (mode) {
          return function __do() {
              var v = DOM_Editor.getElementById("description")(doc)();
              var v1 = DOM_Editor.newSVG("position: absolute; width: 500px; height: 400px;")(v)();
              var root = SVG_Geometry.point("")(12.0)(175.0);
              var nodeA = SVG_Geometry.point("")(100.0)(92.0);
              var nodeA$prime = SVG_Geometry.point("")(100.0)(244.0);
              var startA = SVG_Geometry.point("")(134.0)(80.0);
              var endAB = SVG_Geometry.point("")(202.0)(24.0);
              var endAB$prime = SVG_Geometry.point("")(202.0)(136.0);
              var startA$prime = SVG_Geometry.point("")(134.0)(264.0);
              var endA$primeB = SVG_Geometry.point("")(202.0)(208.0);
              var endA$primeB$prime = SVG_Geometry.point("")(202.0)(320.0);
              var frameTL = SVG_Geometry.point("")(0.0)(0.0);
              var frameTR = SVG_Geometry.point("")(490.0)(0.0);
              var frameBR = SVG_Geometry.point("")(490.0)(350.0);
              var frameBL = SVG_Geometry.point("")(0.0)(350.0);
              var context = {
                  svg: v1,
                  stroke: "#000",
                  strokeWidth: 1.5,
              ...
              SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(root)(nodeA)(Data_Maybe.Nothing.value))();
              SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(root)(nodeA$prime)(Data_Maybe.Nothing.value))();
              SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(startA)(endAB)(Data_Maybe.Nothing.value))();
              SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(startA)(endAB$prime)(Data_Maybe.Nothing.value))();
              SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(startA$prime)(endA$primeB)(Data_Maybe.Nothing.value))();
              SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(startA$prime)(endA$primeB$prime)(Data_Maybe.Nothing.value))();
              var pF = (function () {
                  if (mode) {
                      return "0.52";
                  };
              ...
              return KaTeX.render("\\begin{array}{ccccccccc} & & & & & & & & S \\\\ " + ("& & & & & " + (" \\\\ \\\\ " + ("& & & & F \\\\ " + ("& " + (pF + (" \\\\ " + ("& & & & & " + (" \\\\ " + ("& & & & & & & &" + ("\\overline{S} \\\\ " + ("\\cdot \\\\ " + ("& & & & &\xa0& & &" + ("S \\\\ " + ("& & & & &" + (pgnFS + (" \\\\ " + ("&" + (pnF + (" \\\\ " + ("& & & & \\overline{F} \\\\ \\\\" + ("& & & & & " + (pgnFnS + (" \\\\ " + "& & & & & & & & \\overline{S} \\end{array}"))))))))))))))))))))))))();
          };
      };
  };
  var exo2 = function (v) {
      return function (doc) {
          return function (mode) {
              return function __do() {
                  KaTeX.emph("Dans cet exercice, on arrondira les r\xe9sultats au milli\xe8me.")();
                  KaTeX.newline();
                  KaTeX.raw("Une entreprise sp\xe9cialis\xe9e dans la fabrication de confitures fait appel \xe0 des producteurs locaux.")();
                  KaTeX.newline();
                  KaTeX.raw("\xc0 la livraison, l\u2019entreprise effectue un contr\xf4le qualit\xe9 \xe0 l\u2019issue duquel les fruits sont s\xe9lectionn\xe9s ou non pour la pr\xe9paration des confitures.")();
                  KaTeX.newline();
                  KaTeX.raw("Une \xe9tude statistique a \xe9tabli que :")();
                  KaTeX.list([ KaTeX.cat([ KaTeX.subraw("22% des fruits livr\xe9s sont issus de l\u2019agriculture biologique ;") ]), KaTeX.cat([ KaTeX.subraw("parmi les fruits issus de l\u2019agriculture biologique, 95% sont s\xe9lectionn\xe9s pour la pr\xe9paration des confitures ;") ]), KaTeX.cat([ KaTeX.subraw("parmi les fruits non issus de l\u2019agriculture biologique, 90% sont s\xe9lectionn\xe9s pour la pr\xe9paration des confitures.") ]) ])();
                  KaTeX.raw("On pr\xe9l\xe8ve au hasard un fruit et on note :")();
                  KaTeX.list([ KaTeX.cat([ KaTeX.subrender("B"), KaTeX.subraw(" l'\xe9v\xe9nement \"le fruit est issu de l\u2019agriculture biologique\" ;") ]), KaTeX.cat([ KaTeX.subrender("S"), KaTeX.subraw(" l'\xe9v\xe9nement \"le fruit est s\xe9lectionn\xe9 pour la pr\xe9paration des confitures\".") ]) ])();
                  KaTeX.bold("1\u2022")();
                  KaTeX.raw(" Repr\xe9senter la situation par un arbre pond\xe9r\xe9.")();
                  KaTeX.newline();
                  KaTeX.bold("2\u2022\u25e6")();
                  KaTeX.newline();
                  KaTeX.render("\\quad")();
                  KaTeX.bold("a)")();
                  KaTeX.raw(" Calculer ")();
                  KaTeX.render("p(B\\cap S).")();
                  KaTeX.newline();
                  KaTeX.render("\\quad")();
                  KaTeX.bold("b)")();
                  KaTeX.raw(" Interpr\xe9ter ce r\xe9sultat dans le cadre de l'\xe9nonc\xe9.")();
                  KaTeX.newline();
                  KaTeX.bold("3\u2022\u25e6")();
                  KaTeX.raw(" Montrer que la probabilit\xe9 que le fruit est selectionn\xe9 pour la pr\xe9paration des confitures vaut 0,911.")();
                  KaTeX.newline();
                  KaTeX.bold("4\u2022")();
                  KaTeX.raw(" Sachant que le fruit a \xe9t\xe9 selectionn\xe9 pour la pr\xe9paration des confitures, d\xe9terminer la probabilit\xe9 qu'il ne soit pas issu de l'agriculture biologique.")();
                  if (mode) {
                      KaTeX.newline();
                      return KaTeX.raw("r\xe9ponses: 1)2)a)p(B/\\S)=0.209 b)3)pS(nB)~0.771")();
                  };
                  return Data_Unit.unit;
              };
          };
      ...
      return function (doc) {
          return function (mode) {
              return function __do() {
                  KaTeX.emph("Dans cet exercice, on arrondira les r\xe9sultats au milli\xe8me.")();
                  KaTeX.newline();
                  KaTeX.raw("Une agence P\xf4le Emploi \xe9tudie l'ensemble des demandeurs d'emploi selon deux crit\xe8res, le sexe et l'exp\xe9rience professionnelle.")();
                  KaTeX.newline();
                  KaTeX.raw("Cette \xe9tude montre que :")();
                  KaTeX.newline();
                  KaTeX.list([ KaTeX.cat([ KaTeX.subraw("52% des demandeurs d'emploi sont des femmes et 48% sont des hommes ;") ]), KaTeX.cat([ KaTeX.subraw("18% des demandeurs d'emploi sont sans exp\xe9rience et les autres sont avec exp\xe9rience ;") ]), KaTeX.cat([ KaTeX.subraw("parmi les hommes qui sont demandeurs d'emploi, on sait que 17,5% sont sans exp\xe9rience.") ]) ])();
                  KaTeX.newline();
                  KaTeX.raw("On pr\xe9l\xe8ve au hasard la fiche d'un demandeur d'emploi de cette agence. On note:")();
                  KaTeX.newline();
                  KaTeX.list([ KaTeX.cat([ KaTeX.subrender("S"), KaTeX.subraw(" : l'\xe9v\xe9nement \"le demandeur d'emploi est sans exp\xe9rience\" ;") ]), KaTeX.cat([ KaTeX.subrender("F"), KaTeX.subraw(" : l'\xe9v\xe9nement \"le demandeur d'emploi est une femme\".") ]) ])();
                  KaTeX.newline();
                  KaTeX.bold("1\u2022")();
                  KaTeX.raw(" Pr\xe9ciser ")();
                  KaTeX.render("p(S)")();
                  KaTeX.raw(" et ")();
                  KaTeX.render("p_{\\overline{F}}(S)")();
                  KaTeX.raw(".")();
                  KaTeX.newline();
                  KaTeX.bold("2\u2022")();
                  KaTeX.raw(" Recopier l'arbre ci-dessous et compl\xe9ter les pointill\xe9s par les probabilit\xe9s associ\xe9es.")();
                  KaTeX.newline();
                  tree(doc)(mode)();
                  KaTeX.newline();
                  KaTeX.bold("3\u2022")();
                  KaTeX.raw(" D\xe9montrer que ")();
                  KaTeX.render("p(\\overline{F}\\cap S)=0,084")();
                  KaTeX.raw(". Interpr\xe9ter le r\xe9sultat.")();
                  KaTeX.newline();
                  KaTeX.bold("4\u2022")();
                  KaTeX.raw(" La fiche pr\xe9lev\xe9e est celle d'un demandeur d'emploi sans exp\xe9rience. Calculer la probabilit\xe9 pour que ce soit un homme.")();
                  KaTeX.newline();
                  KaTeX.bold("5\u2022")();
                  KaTeX.newline();
                  KaTeX.render("\\quad")();
                  KaTeX.bold(" a)")();
                  KaTeX.raw(" Justifier que ")();
                  KaTeX.render("p(S\\cap F)=0,096.")();
                  KaTeX.newline();
                  KaTeX.render("\\quad")();
                  KaTeX.bold(" b)")();
                  KaTeX.raw(" Sachant que la fiche pr\xe9lev\xe9e est celle d'une femme, calculer la probabilit\xe9 que ce soit la fiche d'un demandeur d'emploi sans exp\xe9rience.")();
                  if (mode) {
                      KaTeX.newline();
                      return KaTeX.raw("r\xe9ponses: 1) p(S)=0.18 pnF(S)=0.175 2)3)4) pS(nF)~0.467 5)a)b) pF(S)~0.185")();
                  };
                  return Data_Unit.unit;
              };
          };
  ...
  var first = function (r) {
      return function (doc) {
          return function (mode) {
              var arr = [ exo1(r)(doc)(mode), exo2(r)(doc)(mode) ];
              return Data_Maybe.fromJust()(Data_Array.index(arr)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r.val)(Data_Array.length(arr))));
          };
      };
  };
  exports["first"] = first;
...
(function($PS) {
  ...
  var Rand = $PS["Rand"];                
  var problems = [ {
      q: "La probabilit\xe9 que le lecteur choisisse un roman policier est",
      a: "0,4",
      b: "0,75",
      c: "\\dfrac{1}{7}",
      r: "b"
  }, {
      q: "La probabilit\xe9 que le lecteur choisisse une biographie est",
      a: "\\dfrac{1}{4}",
      b: "\\dfrac{6}{7}",
      c: "0,6",
      r: "a"
  }, {
      q: "Le lecteur ayant choisi un roman policier, la probabilit\xe9 que l\u2019auteur soit fran\xe7ais est",
      a: "0,3",
      b: "0,8",
      c: "0,4",
      r: "c"
  }, {
      q: "Le lecteur ayant choisi une biographie, la probabilit\xe9 que l\u2019auteur soit fran\xe7ais est",
      a: "0,7",
      b: "0,5",
      c: "0,2",
      r: "a"
  }, {
      q: "La probabilit\xe9 que le lecteur choisisse un roman policier fran\xe7ais est",
      a: "1,15",
      b: "0,4",
      c: "0,3",
      r: "c"
  }, {
      q: "La probabilit\xe9 que le lecteur choisisse une biographie fran\xe7aise est",
      a: "0,15",
      b: "0,175",
      c: "0,125",
      r: "b"
  }, {
      q: "La probabilit\xe9 que le lecteur choisisse un livre d\u2019un \xe9crivain fran\xe7ais est",
      a: "0,9",
      b: "0,7",
      c: "0,475",
      r: "c"
  }, {
      q: "La probabilit\xe9 que le lecteur ait choisi un roman policier sachant que l\u2019\xe9crivain est fran\xe7ais est",
      a: "\\dfrac{3}{7}",
      b: "\\dfrac{12}{19}",
      c: "0,3",
      r: "b"
  }, {
      q: "La probabilit\xe9 que le lecteur ait choisi une biographie sachant que l\u2019\xe9crivain est fran\xe7ais est",
      a: "\\dfrac{7}{19}",
      b: "\\dfrac{4}{7}",
      c: "0,7",
      r: "a"
  }, {
      q: "Le choix d'un roman policier et le choix d'un livre d'un auteur fran\xe7ais ne sont pas ind\xe9pendants. Si on voulait rendre ces choix ind\xe9pendants, le nombre de romans policiers d'\xe9crivains fran\xe7ais \xe0 ajouter au stock serait",
      a: "200",
      b: "105",
      c: "45",
      r: "a"
  }, {
      q: "La probabilit\xe9 que lecteur choisisse une biographie ou un livre d'un auteur fran\xe7ais est",
      a: "\\dfrac{19}{40}",
      b: "\\dfrac{11}{20}",
      c: "0.375",
      r: "b"
  ...
  var exo1 = function (r) {
      return function (doc) {
          return function (mode) {
              return function __do() {
                  KaTeX.emph("Cet exercice est un questionnaire \xe0 choix multiple. Pour chaque question, une seule des r\xe9ponses propos\xe9es est correcte. Une bonne r\xe9ponse rapporte 1 point, une mauvaise r\xe9ponse enl\xe8ve 1 point tant que la note globale reste positive. Une absence de r\xe9ponse n'apporte et n'enl\xe8ve aucun point. Aucune justification n'est exig\xe9e.")();
                  KaTeX.newline();
                  KaTeX.raw("Un lecteur d'une biblioth\xe8que est passionn\xe9 de romans policiers et de biographies. Cette biblioth\xe8que lui propose 150 romans policiers et 50 biographies.")();
                  KaTeX.newline();
                  KaTeX.raw("40% des \xe9crivains de romans policiers sont fran\xe7ais et 70% des \xe9crivains de biographies sont fran\xe7ais.")();
                  KaTeX.newline();
                  KaTeX.raw("Le lecteur choisit un livre au hasard parmi les 200 ouvrages.")();
                  KaTeX.newline();
                  KaTeX.newline();
                  var chosen_indices = Rand.unsort(Data_Array.length(problems))(r);
                  ...
                  Data_FoldableWithIndex.forWithIndex_(Effect.applicativeEffect)(Data_FoldableWithIndex.foldableWithIndexArray)(chosen_problems)(function (i) {
                      return function (p) {
                          return function __do() {
                              KaTeX.bold(Data_Show.show(Data_Show.showInt)(i + 1 | 0) + ". ")();
                              KaTeX.raw(p.q + " :")();
                              KaTeX.newline();
                              KaTeX.newline();
                              KaTeX.raw("(a) ")();
                              KaTeX.render(p.a)();
                              KaTeX.render("\\quad\\quad")();
                              KaTeX.raw("(b) ")();
                              KaTeX.render(p.b)();
                              KaTeX.render("\\quad\\quad")();
                              KaTeX.raw("(c) ")();
                              KaTeX.render(p.c)();
                              KaTeX.newline();
                              return KaTeX.newline();
                          };
                      };
                  })();
                  if (mode) {
                      return KaTeX.raw("r\xe9ponses: " + Data_FoldableWithIndex.foldMapWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(Data_Monoid.monoidString)(function (i) {
                          return function (a) {
              ...
              return function __do() {
                  Data_FoldableWithIndex.forWithIndex_(Effect.applicativeEffect)(Data_FoldableWithIndex.foldableWithIndexArray)(chosen_problems)(function (i) {
                      return function (p) {
                          return function __do() {
                              KaTeX.bold(Data_Show.show(Data_Show.showInt)(i + 1 | 0) + "\u2022\u2022\u25e6")();
                              KaTeX.raw(" R\xe9soudre dans ")();
                              KaTeX.render(p.domain)();
                              KaTeX.raw(" :")();
                              KaTeX.newline();
                              return KaTeX.equation(p.inequation)();
                          };
                      };
                  })();
                  if (mode) {
                      return KaTeX.render("r\xe9ponses: " + Data_FoldableWithIndex.foldMapWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(Data_Monoid.monoidString)(function (i) {
                          return function (p) {
                              return " " + (Data_Show.show(Data_Show.showInt)(i + 1 | 0) + (") " + (p.answer + "\\quad")));
                          };
                      })(chosen_problems))();
                  };
                  return Data_Unit.unit;
...
(function($PS) {
  ...
  var cb = function (doc) {
      return function (ev) {
          return function __do() {
              ...
              var mode = $foreign.fromString(v) < 0;
              ...
              var r1 = Rand.rand(r0);
              First.first(r1)(doc)(mode)();
              KaTeX.section("Exercice 2")();
              var r2 = Rand.rand(r1);
              Second.second(r2)(doc)(mode)();
              KaTeX.section("Exercice 3")();
              var r3 = Rand.rand(r2);
              Third.third(r3)(doc)(mode)();
              KaTeX.section("Exercice 4")();
              KaTeX.bold("1\u2022\u2022\u25e6")();
              KaTeX.raw(" R\xe9soudre l'in\xe9quation")();
              KaTeX.equation("x+\\dfrac{1}{x}-2\\geq 0.")();
              KaTeX.newline();
              KaTeX.bold("2\u25e6")();
              KaTeX.raw(" En d\xe9duire que, pour tout r\xe9el ")();
              KaTeX.render("a>0, \\quad a+\\dfrac{1}{a}\\geq 2.")();
              KaTeX.newline();
              KaTeX.bold("3\u2022\u2022")();
              KaTeX.raw(" Montrer alors que, pour tous r\xe9els strictement positifs ")();
              KaTeX.render("\\alpha")();
              KaTeX.raw(" et ")();
              KaTeX.render("\\beta")();
              KaTeX.raw(", on a")();
              ...
              KaTeX.render("\\quad")();
              KaTeX.bold("a) ")();
              KaTeX.render("\\quad \\dfrac{\\alpha}{\\beta}+\\dfrac{\\beta}{\\alpha}\\geq 2")();
              KaTeX.newline();
              KaTeX.render("\\quad")();
              KaTeX.bold("b)")();
              return KaTeX.render("\\quad (\\alpha+\\beta)(\\dfrac{1}{\\alpha}+\\dfrac{1}{\\beta})\\geq 4.")();
          };
      };
  };
  var main = Data_Functor["void"](Effect.functorEffect)(function __do() {
      ...
      KaTeX.setTitle("Devoir 5 : Probabilit\xe9s conditionnelles / Fonctions de degr\xe9 2")();
      KaTeX.raw("Nom:")();
