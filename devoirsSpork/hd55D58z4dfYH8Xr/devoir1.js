...
(function($PS) {
  ...
  var relation3 = "\\big(\\frac{352}{1000}\\big)^2+\\big(\\frac{936}{1000}\\big)^2=1";
  var relation2 = "\\big(\\frac{28}{100}\\big)^2+\\big(\\frac{96}{100}\\big)^2=1";
  var relation1 = "\\big(\\frac{6}{10}\\big)^2+\\big(\\frac{8}{10}\\big)^2=1";
  ...
  var symx = function (a) {
      ...
      throw new Error("Failed pattern match at Main (line 52, column 3 - line 65, column 26): " + [ Data_Unit.unit.constructor.name ]);
  };
  var symy = function (a) {
      if (a === m5pi_6) {
          return mpi_6;
      ...
      throw new Error("Failed pattern match at Main (line 70, column 3 - line 83, column 26): " + [ Data_Unit.unit.constructor.name ]);
  };
  ...
  var positive = function (a) {
      ...
      throw new Error("Failed pattern match at Main (line 95, column 3 - line 102, column 26): " + [ Data_Unit.unit.constructor.name ]);
  };
  var sixths = [ {
      exact: "\\frac{-13\\pi}{6}",
  ...
  var rand = function (v) {
      var y = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)((v.gen * ((4 * v.gen | 0) + 1 | 0) | 0) + 1 | 0)(aVeryBigPowerOf2);
      return {
          val: Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(y)(Data_Array.length(points)),
          gen: y
      };
  };
  var cb = function (doc) {
      return function (ev) {
          return function __do() {
              ...
              var r0 = rand({
                  val: Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)($foreign.fromString(v)),
                  gen: Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)($foreign.fromString(v))
              });
              KaTeX.newline();
              KaTeX.list([ KaTeX.cat([ KaTeX.subraw("10 questions") ]), KaTeX.cat([ KaTeX.subrender("\\frac{1}{2}"), KaTeX.subraw(" point par bonne r\xe9ponse") ]), KaTeX.cat([ KaTeX.subraw("sans calculatrice") ]) ])();
              KaTeX.newline();
              KaTeX.raw("1) On consid\xe8re ")();
              KaTeX.render("\\mathcal{C}")();
              KaTeX.raw(" le cercle trigonom\xe9trique suivant :")();
              KaTeX.newline();
              var v1 = DOM_Editor.createElement("div")(doc)();
              var v2 = DOM_Editor.setAttribute("style")("display: grid; grid-template-columns : 1fr 4fr;")(v1)();
              var v3 = DOM_Editor.getElementById("description")(doc)();
              var v4 = DOM_Editor.createElement("div")(doc)();
              var v5 = DOM_Editor.newSVG("position: relative; width: 100%; height: 100%")(v1)();
              var v6 = DOM_Editor.appendChild(v4)(v1)();
              var v7 = DOM_Editor.appendChild(v1)(v3)();
              var ctx = (function () {
                  var v8 = SVG_Render.defaultContext(v5);
                  return {
                      strokeWidth: 1.0,
                      fill: v8.fill,
                      fontStyle: v8.fontStyle,
                      stroke: v8.stroke,
                      svg: v8.svg,
                      textFill: v8.textFill
                  };
              })();
              var draw = function (dictRender) {
                  return SVG_Render["render'"](dictRender)(ctx);
              };
              var pO = SVG_Geometry.point("O")(80.0)(80.0);
              var pI = SVG_Geometry.point("I")(80.0 + 70.0)(80.0);
              var pJ = SVG_Geometry.point("J")(80.0)(80.0 - 70.0);
              draw(SVG_Render.renderSequence(SVG_Render.renderPoint))([ pO, pI, pJ ])();
              draw(SVG_Render.renderCircle)(SVG_Geometry.circle(pO)(SVG_Geometry.length(SVG_Geometry.measurableVector)(SVG_Geometry.vector(pO)(pI))))();
              draw(SVG_Render.renderSegment)(SVG_Geometry.segment(pO)(pI)(Data_Maybe.Nothing.value))();
              draw(SVG_Render.renderSegment)(SVG_Geometry.segment(pO)(pJ)(Data_Maybe.Nothing.value))();
              var angle0 = Data_Maybe.fromJust()(Data_Array.index(points)(r0.val));
              var pM = SVG_Geometry.point("M")(80.0 + 70.0 * $$Math.cos(angle0.approx))(80.0 - 70.0 * $$Math.sin(angle0.approx));
              draw(SVG_Render.renderPoint)(pM)();
              draw(SVG_Render.renderSegment)(SVG_Geometry.segment(pO)(pM)(Data_Maybe.Nothing.value))();
              KaTeX.rawIn(v4)("Soit ")();
              KaTeX.renderIn(v4)("M")();
              KaTeX.rawIn(v4)(" le point de coordonn\xe9es ")();
              KaTeX.renderIn(v4)("(" + (angle0.cos + ("," + (angle0.sin + ")."))))();
              KaTeX.newlineIn(v4)();
              KaTeX.rawIn(v4)("Donner la valeur (en radians) du r\xe9el compris dans l'intervalle ")();
              KaTeX.renderIn(v4)("]-\\pi, \\pi]")();
              KaTeX.rawIn(v4)(" correspondant au point ")();
              KaTeX.renderIn(v4)("M:")();
              KaTeX.newline();
              KaTeX.raw("2) Compl\xe9ter la phrase en rempla\xe7ant chaque mot manquant par ")();
              KaTeX.render("\\underline{\xe9gaux}")();
              KaTeX.raw(" ou ")();
              KaTeX.render("\\underline{oppos\xe9s}:")();
              var r1 = rand(r0);
              var arr = (function () {
                  var v8 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r1.val)(3);
                  if (v8 === 0) {
                      return thirds;
                  };
                  if (v8 === 1) {
              ...
              var r2 = rand(r1);
              var i1 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r2.val)(n);
              var r3 = rand(r2);
              var i2 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)((i1 + 1 | 0) + Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r3.val)(n - 1 | 0) | 0)(n);
              var angle1 = Data_Maybe.fromJust()(Data_Array.index(arr)(i1));
              var angle2 = Data_Maybe.fromJust()(Data_Array.index(arr)(i2));
              KaTeX.newline();
              KaTeX.raw("Les r\xe9els ")();
              KaTeX.render(angle1.exact)();
              KaTeX.raw(" et ")();
              KaTeX.render(angle2.exact)();
              KaTeX.raw(" ont leurs cosinus ")();
              KaTeX.render("\\underline{" + (spacex(16) + "}"))();
              KaTeX.raw(" et leurs sinus ")();
              KaTeX.render("\\underline{" + (spacex(16) + "}."))();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.raw("3) Donner la valeur du r\xe9el ")();
              KaTeX.render("a")();
              var r4 = rand(r3);
              var angle3 = Data_Maybe.fromJust()(Data_Array.index(points)(r4.val));
              KaTeX.raw(" de l'intervalle ")();
              KaTeX.render("[0, 2\\pi[")();
              KaTeX.raw(" v\xe9rifiant ")();
              KaTeX.newline();
              KaTeX.render("\\cos(a)=" + angle3.cos)();
              KaTeX.raw(" et ")();
              KaTeX.newline();
              KaTeX.render("\\sin(a)=" + (angle3.sin + ":"))();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.raw("4) Etant donn\xe9 que ")();
              var r5 = rand(r4);
              var cosa = Data_Maybe.fromJust()(Data_Array.index(decimals)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r5.val)(Data_Array.length(decimals))));
              KaTeX.equation(cosa.origin)();
              KaTeX.newline();
              KaTeX.raw(" et sachant que ")();
              KaTeX.render("a\\in]-\\pi,0[")();
              KaTeX.raw(", et que ")();
              KaTeX.render("\\cos(a)=" + cosa.decimal)();
              KaTeX.raw(", d\xe9terminer la valeur exacte de ")();
              KaTeX.render("\\sin(a):")();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.raw("5) Convertir ")();
              var r6 = rand(r5);
              var deg = Data_Maybe.fromJust()(Data_Array.index(degrees)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r6.val)(Data_Array.length(degrees))));
              KaTeX.render(deg.degree + "^\\circ")();
              KaTeX.raw(" en radians. On donnera une r\xe9ponse dans ")();
              KaTeX.render("[0, 2\\pi[")();
              KaTeX.raw(" sous la forme exacte la plus simple possible:")();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.raw("6) Convertir ")();
              var r7 = rand(r6);
              var fifth = Data_Maybe.fromJust()(Data_Array.index(fifths)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(r7.val)(Data_Array.length(fifths))));
              KaTeX.render(fifth.radian)();
              KaTeX.raw(" en degr\xe9s. On donnera un entier positif inf\xe9rieur \xe0 ")();
              KaTeX.render("359^\\circ")();
              KaTeX.raw(":")();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              ...
              KaTeX.raw("7) Soit ")();
              KaTeX.render("M")();
              KaTeX.raw(" le point du cercle trigonom\xe9trique v\xe9rifiant ")();
              var r8 = rand(r7);
              var angle4 = Data_Maybe.fromJust()(Data_Array.index(points)(r8.val));
              KaTeX.render("\\widehat{IOM} =" + angle4.exact)();
              KaTeX.raw(" (remarque: on \xe9crit aussi ")();
              KaTeX.render("(\\overrightarrow{OI},\\overrightarrow{OM})=" + angle4.exact)();
              KaTeX.raw("). Donner la valeur de ")();
              KaTeX.render("\\widehat{IOM'} ")();
              KaTeX.raw(" comprise entre ")();
              KaTeX.render("-\\pi")();
              KaTeX.raw(" et ")();
              KaTeX.render("\\pi")();
              KaTeX.raw(" si ")();
              KaTeX.render("M'")();
              KaTeX.raw(" est le sym\xe9trique de ")();
              KaTeX.render("M")();
              KaTeX.raw(" par la sym\xe9trie d'axe ")();
              KaTeX.render("(OI):")();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              ...
              KaTeX.raw(" le point du cercle trigonom\xe9trique v\xe9rifiant ")();
              var r9 = rand(r8);
              var angle5 = Data_Maybe.fromJust()(Data_Array.index(points)(r9.val));
              KaTeX.render("\\widehat{IOM} =" + angle5.exact)();
              KaTeX.raw(". Donner la valeur de ")();
              KaTeX.render("\\widehat{IOM'}")();
              KaTeX.raw(" comprise entre ")();
              KaTeX.render("-\\pi")();
              ...
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.raw("9) Donner la valeur de ")();
              KaTeX.render("\\cos(" + (angle4.exact + "):"))();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.raw("10) Donner la valeur de ")();
              KaTeX.render("\\sin(" + (angle5.exact + "):"))();
              KaTeX.newline();
              KaTeX.newline();
              KaTeX.newline();
              var rep = [ "r\xe9ponses: 1)", angle0.princ, "\\;2)", (function () {
                  var $30 = angle1.cos === angle2.cos;
                  if ($30) {
                      return "\xe9gaux,";
                  };
                  return "oppos\xe9s,";
              })() + (function () {
                  var $31 = angle1.sin === angle2.sin;
                  if ($31) {
                      return "\xe9gaux";
                  };
                  return "oppos\xe9s";
  ...
  var main = Data_Functor["void"](Effect.functorEffect)(function __do() {
      ...
      KaTeX.setTitle("Devoir 1 : Trigonom\xe9trie")();
      KaTeX.raw("Nom:")();
  ...
  exports["relation1"] = relation1;
  exports["relation2"] = relation2;
  exports["relation3"] = relation3;
