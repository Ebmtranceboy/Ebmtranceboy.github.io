...
(function($PS) {
  ...
  var ptot = function (pa) {
      return function (pab) {
          return function (panb) {
              return function (e) {
                  var $36 = [ Data_Map_Internal.lookup(Data_Ord.ordString)(pa)(e), Data_Map_Internal.lookup(Data_Ord.ordString)(pab)(e), Data_Map_Internal.lookup(Data_Ord.ordString)(panb)(e) ];
                  if ($36.length === 3 && ($36[0] instanceof Data_Maybe.Just && ($36[1] instanceof Data_Maybe.Just && $36[2] instanceof Data_Maybe.Nothing))) {
                      return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(panb)(Data_Ring.sub(Fraction.ringFraction)($36[0].value0)($36[1].value0))(e));
                  };
                  if ($36.length === 3 && ($36[0] instanceof Data_Maybe.Just && ($36[1] instanceof Data_Maybe.Nothing && $36[2] instanceof Data_Maybe.Just))) {
                      return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pab)(Data_Ring.sub(Fraction.ringFraction)($36[0].value0)($36[2].value0))(e));
                  };
                  if ($36.length === 3 && ($36[0] instanceof Data_Maybe.Nothing && ($36[1] instanceof Data_Maybe.Just && $36[2] instanceof Data_Maybe.Just))) {
                      return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pa)(Data_Semiring.add(Fraction.semiRingFraction)($36[1].value0)($36[2].value0))(e));
                  };
                  return Data_Maybe.Nothing.value;
              };
          };
  ...
  var print = function (e) {
      return function (key) {
          ...
          throw new Error("Failed pattern match at Main (line 130, column 9 - line 132, column 27): " + [ v.constructor.name ]);
      };
  };
  var tree = function (doc) {
      return function (e) {
          return function __do() {
              ...
              var startA = SVG_Geometry.point("")(126.0)(80.0);
              var endAB = SVG_Geometry.point("")(202.0)(24.0);
              var endAB$prime = SVG_Geometry.point("")(202.0)(136.0);
              var startA$prime = SVG_Geometry.point("")(126.0)(264.0);
              ...
              SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(frameTL)(frameTR)(Data_Maybe.Nothing.value))();
              SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(frameTR)(frameBR)(Data_Maybe.Nothing.value))();
              SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(frameBR)(frameBL)(Data_Maybe.Nothing.value))();
              SVG_Render["render'"](SVG_Render.renderSegment)(context)(SVG_Geometry.segment(frameBL)(frameTL)(Data_Maybe.Nothing.value))();
              ...
              var dress = function (str) {
                  return function (x) {
                      return function (k) {
                          var v2 = Data_Map_Internal.lookup(Data_Ord.ordString)(k)(x);
                          if (v2 instanceof Data_Maybe.Just) {
                              return "&&&" + (str + (Data_Show.show(Fraction.showFraction)(v2.value0) + " \\\\"));
                          };
                          if (v2 instanceof Data_Maybe.Nothing) {
                              return "";
                          };
                          throw new Error("Failed pattern match at Main (line 188, column 9 - line 190, column 25): " + [ v2.constructor.name ]);
                      };
                  };
              };
              ...
              return KaTeX.render("\\begin{array}{llllllllllll}" + (pB$prime + (pnB$prime + (pAB$prime + (pAnB$prime + (pnAB$prime + (pnAnB$prime + (pgBA$prime + (pgBnA$prime + (pgnBA$prime + (pgnBnA$prime + ("\\\\ & & & & & & & & & & & & \\\\" + "\\end{array}"))))))))))))();
          };
      };
  };
      ...
      return function (pb) {
          return function (pgab) {
              return function (pgnab) {
                  return function (e) {
                      var $58 = [ Data_Map_Internal.lookup(Data_Ord.ordString)(pa)(e), Data_Map_Internal.lookup(Data_Ord.ordString)(pb)(e), Data_Map_Internal.lookup(Data_Ord.ordString)(pgab)(e), Data_Map_Internal.lookup(Data_Ord.ordString)(pgnab)(e) ];
                      if ($58.length === 4 && ($58[0] instanceof Data_Maybe.Just && ($58[1] instanceof Data_Maybe.Just && ($58[2] instanceof Data_Maybe.Just && $58[3] instanceof Data_Maybe.Nothing)))) {
                          return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pgnab)(Data_EuclideanRing.div(Fraction.euclideanRingFraction)(Data_Ring.sub(Fraction.ringFraction)($58[1].value0)(Data_Semiring.mul(Fraction.semiRingFraction)($58[2].value0)($58[0].value0)))(Data_Ring.sub(Fraction.ringFraction)(Fraction.fromInt(1))($58[0].value0)))(e));
                      };
                      if ($58.length === 4 && ($58[0] instanceof Data_Maybe.Just && ($58[1] instanceof Data_Maybe.Just && ($58[2] instanceof Data_Maybe.Nothing && $58[3] instanceof Data_Maybe.Just)))) {
                          return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pgab)(Data_EuclideanRing.div(Fraction.euclideanRingFraction)(Data_Ring.sub(Fraction.ringFraction)($58[1].value0)(Data_Semiring.mul(Fraction.semiRingFraction)($58[3].value0)(Data_Ring.sub(Fraction.ringFraction)(Fraction.fromInt(1))($58[0].value0))))($58[0].value0))(e));
                      };
                      if ($58.length === 4 && ($58[0] instanceof Data_Maybe.Just && ($58[1] instanceof Data_Maybe.Nothing && ($58[2] instanceof Data_Maybe.Just && $58[3] instanceof Data_Maybe.Just)))) {
                          return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pb)(Data_Semiring.add(Fraction.semiRingFraction)(Data_Semiring.mul(Fraction.semiRingFraction)($58[2].value0)($58[0].value0))(Data_Semiring.mul(Fraction.semiRingFraction)($58[3].value0)(Data_Ring.sub(Fraction.ringFraction)(Fraction.fromInt(1))($58[0].value0))))(e));
                      };
                      if ($58.length === 4 && ($58[0] instanceof Data_Maybe.Nothing && ($58[1] instanceof Data_Maybe.Just && ($58[2] instanceof Data_Maybe.Just && $58[3] instanceof Data_Maybe.Just)))) {
                          return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pa)(Data_EuclideanRing.div(Fraction.euclideanRingFraction)(Data_Ring.sub(Fraction.ringFraction)($58[1].value0)($58[3].value0))(Data_Ring.sub(Fraction.ringFraction)($58[2].value0)($58[3].value0)))(e));
                      };
                      return Data_Maybe.Nothing.value;
                  };
              };
  ...
  var contr = function (pa) {
      return function (pna) {
          return function (e) {
              var $87 = [ Data_Map_Internal.lookup(Data_Ord.ordString)(pa)(e), Data_Map_Internal.lookup(Data_Ord.ordString)(pna)(e) ];
              if ($87.length === 2 && ($87[0] instanceof Data_Maybe.Just && $87[1] instanceof Data_Maybe.Nothing)) {
                  return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pna)(Data_Ring.sub(Fraction.ringFraction)(Fraction.fromInt(1))($87[0].value0))(e));
              };
              if ($87.length === 2 && ($87[0] instanceof Data_Maybe.Nothing && $87[1] instanceof Data_Maybe.Just)) {
                  return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pa)(Data_Ring.sub(Fraction.ringFraction)(Fraction.fromInt(1))($87[1].value0))(e));
              };
              return Data_Maybe.Nothing.value;
          };
      };
  ...
  var cond = function (pc) {
      return function (pi) {
          return function (pr) {
              return function (e) {
                  var $94 = [ Data_Map_Internal.lookup(Data_Ord.ordString)(pc)(e), Data_Map_Internal.lookup(Data_Ord.ordString)(pi)(e), Data_Map_Internal.lookup(Data_Ord.ordString)(pr)(e) ];
                  if ($94.length === 3 && ($94[0] instanceof Data_Maybe.Just && ($94[1] instanceof Data_Maybe.Just && $94[2] instanceof Data_Maybe.Nothing))) {
                      return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pr)(Data_EuclideanRing.div(Fraction.euclideanRingFraction)($94[1].value0)($94[0].value0))(e));
                  };
                  if ($94.length === 3 && ($94[0] instanceof Data_Maybe.Just && ($94[1] instanceof Data_Maybe.Nothing && $94[2] instanceof Data_Maybe.Just))) {
                      return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pi)(Data_Semiring.mul(Fraction.semiRingFraction)($94[0].value0)($94[2].value0))(e));
                  };
                  if ($94.length === 3 && ($94[0] instanceof Data_Maybe.Nothing && ($94[1] instanceof Data_Maybe.Just && $94[2] instanceof Data_Maybe.Just))) {
                      return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordString)(pc)(Data_EuclideanRing.div(Fraction.euclideanRingFraction)($94[1].value0)($94[2].value0))(e));
                  };
                  return Data_Maybe.Nothing.value;
              };
          };
      ...
      function $tco_loop(r) {
          ...
          if (v instanceof Data_Maybe.Just) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 116, column 7 - line 120, column 50): " + [ Data_Unit.unit.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 107, column 7 - line 107, column 28): " + [ v1.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 104, column 7 - line 104, column 28): " + [ v.constructor.name ]);
      };
      while (!$tco_done) {
  ...
  var randExercise = function ($copy_r1) {
      ...
      function $tco_loop(r1) {
          ...
          var f3 = function ($copy_r) {
              return function ($copy_s) {
                  ...
                  function $tco_loop(r, s) {
                      var t = Rand.rand(s);
                      var $121 = modMaj(t.val) === modMaj(r.val) || modMaj(t.val) === modMaj(s.val);
                      if ($121) {
                          $tco_var_r = s;
                          $copy_s = t;
                          return;
          ...
          var f2 = function ($copy_r) {
              ...
              function $tco_loop(r) {
                  var s = Rand.rand(r);
                  var $122 = modMaj(s.val) === modMaj(r.val);
                  if ($122) {
                      $copy_r = s;
                      return;
                  };
          ...
          var $126 = validExperience(complete(e));
          if ($126) {
              $tco_done = true;
              return {
                  experience: e,
  ...
  var cb = function (doc) {
      return function (ev) {
          return function __do() {
              ...
              KaTeX.newline();
              KaTeX.list([ KaTeX.cat([ KaTeX.subraw("5 arbres pond\xe9r\xe9s \xe0 compl\xe9ter \xe0 partir des hypoth\xe8ses") ]), KaTeX.cat([ KaTeX.subraw("1 point par arbre complet") ]), KaTeX.cat([ KaTeX.subraw("calculatrice autoris\xe9e") ]), KaTeX.cat([ KaTeX.subraw("documents autoris\xe9s") ]), KaTeX.cat([ KaTeX.subraw("toute valeur num\xe9rique sous forme fractionnaire") ]) ])();
              KaTeX.newline();
              var r1 = Rand.rand(r0);
              var prob = function (e) {
                  var $134 = $foreign.fromString(v) < 0;
                  if ($134) {
                      return tree(doc)(complete(e));
                  };
                  return tree(doc)(e);
              };
              var v1 = randExercise(r1);
              prob(v1.experience)();
              ...
              prob(v4.experience)();
              KaTeX.subsection("")();
              var v5 = randExercise(v4.nextRand);
              return prob(v5.experience)();
          };
      };
  };
