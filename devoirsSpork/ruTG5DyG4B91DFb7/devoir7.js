...
(function($PS) {
  ...
  var showSeq = function (v) {
      return (function () {
          ...
          return Data_Show.show(Data_Show.showInt)(v.a) + "n";
      })() + (function () {
          var $4 = v.b < 0;
          if ($4) {
              return Data_Show.show(Data_Show.showInt)(v.b);
          };
          return "+" + Data_Show.show(Data_Show.showInt)(v.b);
      })();
  };
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("(u_n)"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" la suite d\xe9finie sur "))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\mathbb{N}"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" par "))(function () {
                                          ...
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("u_n = " + showSeq({
                                              a: v.a,
                                              b: v.b
                                          })))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("u_0=" + (spacing + ("u_1=" + (spacing + ("u_2=" + (spacing + "u_3=")))))))(function () {
                                                              var $9 = model.code < 0;
                                                              if ($9) {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("r\xe9ponse: "))(function () {
                                                                          return SporKaTeX.t(Data_Show.show(Data_Show.showArray(Data_Show.showInt))([ v.b, v.a + v.b | 0, (2 * v.a | 0) + v.b | 0, (3 * v.a | 0) + v.b | 0 ]));
                                                                      });
                                                                  });
                                                              };
...
(function($PS) {
  ...
  var showSeq = function (v) {
      return (function () {
          ...
          return Data_Show.show(Data_Show.showInt)(v.a) + "v_n";
      })() + (function () {
          var $4 = v.b < 0;
          if ($4) {
              return Data_Show.show(Data_Show.showInt)(v.b);
  ...
  var randomParam = function ($copy_r) {
      ...
      function $tco_loop(r) {
          ...
          var rb = Rand.rand(ra);
          var rc = Rand.rand(rb);
          var c = randomInteger(rc);
          var b = randomInteger(rb);
          var a = randomInteger(ra);
          var ok = c !== 0 && (a !== 1 && (a !== 0 && b !== 0));
          if (ok) {
              $tco_done = true;
              return {
                  a: a,
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("(v_n)"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" la suite d\xe9finie sur "))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\mathbb{N}"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" par "))(function () {
                                          var v = randomParam(r0);
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\left\\{\\begin{array}{l}v_0=" + (Data_Show.show(Data_Show.showInt)(v.c) + ("\\\\" + ("v_{n+1}=" + (showSeq({
                                              a: v.a,
                                              b: v.b,
                                              c: v.c
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("v_0=" + (spacing + ("v_1=" + (spacing + ("v_2=" + (spacing + "v_3=")))))))(function () {
                                                              var $10 = model.code < 0;
                                                              if ($10) {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("r\xe9ponse: "))(function () {
                                                                          return SporKaTeX.t(Data_Show.show(Data_Show.showArray(Data_Show.showInt))([ v.c, (v.a * v.c | 0) + v.b | 0, (v.a * ((v.a * v.c | 0) + v.b | 0) | 0) + v.b | 0, (v.a * ((v.a * ((v.a * v.c | 0) + v.b | 0) | 0) + v.b | 0) | 0) + v.b | 0 ]));
                                                                      });
                                                                  });
                                                              };
                                                              return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Data_Monoid.mempty(Data_Monoid.monoidUnit));
...
(function($PS) {
  ...
  var showSeq = function (v) {
      return (function () {
          ...
          var $4 = v.b < 0;
          if ($4) {
              return "-" + ("\\dfrac{" + (Data_Show.show(Data_Show.showInt)(-v.b | 0) + ("}{n+" + (Data_Show.show(Data_Show.showInt)(v.c) + "}"))));
          };
          return "+" + ("\\dfrac{" + (Data_Show.show(Data_Show.showInt)(v.b) + ("}{n+" + (Data_Show.show(Data_Show.showInt)(v.c) + "}"))));
      })();
  };
          ...
          return function (equation) {
              return function (r0) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.section("Exercice 3"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("(w_n)"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" la suite d\xe9finie sur "))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\mathbb{N}"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" par "))(function () {
                                          var v = randomParam(r0);
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("w_n = " + showSeq({
                                              a: v.a,
                                              b: v.b,
                                              c: v.c
                                          })))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("w_0=" + (spacing + ("w_1=" + (spacing + ("w_2=" + (spacing + "w_3=")))))))(function () {
                                                              var $11 = model.code < 0;
                                                              if ($11) {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("r\xe9ponse: "))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("[" + (rshow(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(v.b))(Data_Rational.fromInt(v.c))) + ("," + (rshow(Data_Semiring.add(Data_Ratio.semiringRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(v.a))(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(v.b))(Data_Rational.fromInt(1 + v.c | 0)))) + ("," + (rshow(Data_Semiring.add(Data_Ratio.semiringRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(2 * v.a | 0))(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(v.b))(Data_Rational.fromInt(2 + v.c | 0)))) + ("," + (rshow(Data_Semiring.add(Data_Ratio.semiringRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(3 * v.a | 0))(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(v.b))(Data_Rational.fromInt(3 + v.c | 0)))) + "]")))))))))(function () {
                                                                              return SporKaTeX.t("");
                                                                          });
                                                                      });
                                                                  });
          ...
          return function (equation) {
              return function (r0) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.section("Exercice 4"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("(s_n)"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" la suite d\xe9finie sur "))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\mathbb{N}"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" par "))(function () {
                                          var v = randomParam(r0);
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\left\\{\\begin{array}{l}s_0=" + (Data_Show.show(Data_Show.showInt)(v.a) + ("\\\\" + ("s_{n+1}=" + (showSeq({
                                              a: v.a
                                          }) + "\\end{array}\\right."))))))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("s_0=" + (spacing + ("s_1=" + (spacing + ("s_2=" + (spacing + "s_3=")))))))(function () {
                                                              var $7 = model.code < 0;
                                                              if ($7) {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("r\xe9ponse: "))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("[" + (rshow(Data_Rational.fromInt(v.a)) + ("," + (rshow(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(1))(Data_Rational.fromInt(1 - v.a | 0))) + ("," + (rshow(Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(Data_Rational.fromInt(v.a - 1 | 0))(Data_Rational.fromInt(v.a))) + ("," + (rshow(Data_Rational.fromInt(v.a)) + "]")))))))))(function () {
                                                                              return SporKaTeX.t("");
                                                                          });
                                                                      });
                                                                  });
...
(function($PS) {
  ...
  var showSeq = function (v) {
      ...
      return Data_Show.show(Data_Show.showInt)(v.a) + "n^2-t_n";
  };
  var majorant = 10;
  var randomInteger = function (r) {
      var rsign = Rand.rand(r);
          ...
          return function (equation) {
              return function (r0) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.section("Exercice 5"))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("Soit "))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("(t_n)"))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" la suite d\xe9finie sur "))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\mathbb{N}"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t(" par "))(function () {
                                          var v = randomParam(r0);
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("\\left\\{\\begin{array}{l}t_0=" + (Data_Show.show(Data_Show.showInt)(v.b) + ("\\\\" + ("t_{n+1}=" + (showSeq({
                                              a: v.a,
                                              b: v.b
                                          }) + "\\end{array}\\right."))))))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("."))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(m("t_0=" + (spacing + ("t_1=" + (spacing + ("t_2=" + (spacing + "t_3=")))))))(function () {
                                                              var $8 = model.code < 0;
                                                              if ($8) {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.t("r\xe9ponse: "))(function () {
                                                                          return SporKaTeX.t(Data_Show.show(Data_Show.showArray(Data_Show.showInt))([ v.b, -v.b | 0, v.a + v.b | 0, (3 * v.a | 0) - v.b | 0 ]));
                                                                      });
                                                                  });
                                                              };
                                                              return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Data_Identity.monadIdentity))(Data_Monoid.mempty(Data_Monoid.monoidUnit));
...
(function($PS) {
  ...
  var lines = function (model) {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Exercise1.exo1(model)(m)(equation)(Data_Maybe.fromJust()(Data_Array.index(model.seeds)(0))))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Exercise2.exo2(model)(m)(equation)(Data_Maybe.fromJust()(Data_Array.index(model.seeds)(1))))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Exercise3.exo3(model)(m)(equation)(Data_Maybe.fromJust()(Data_Array.index(model.seeds)(2))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Exercise4.exo4(model)(m)(equation)(Data_Maybe.fromJust()(Data_Array.index(model.seeds)(3))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Exercise5.exo5(model)(m)(equation)(Data_Maybe.fromJust()(Data_Array.index(model.seeds)(4))))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(SporKaTeX.nl)(function () {
